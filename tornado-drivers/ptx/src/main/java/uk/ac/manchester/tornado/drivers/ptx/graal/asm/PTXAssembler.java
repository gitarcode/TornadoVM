...
public class PTXAssembler extends Assembler {
  ...
  /**
   * Converts the format of a given input Value from the Graal format (e.g., V23|FLOAT) to a
   * normalized format suitable for the current PTX backend based on its platform type.
   *
   * <p>This method analyzes the input Value's platform kind and generates a corresponding format
   * string in the normalized PTX format. It keeps track of variables and their mappings to ensure
   * uniqueness and consistency of generated format strings.
   *
   * @param input The {@link Value} input to be converted.
  ...
  public static String convertValueFromGraalFormat(Value input) {
    ...
    if (retVars != null && retVars.contains(input)) {
      ...
      boolean isArray =
          vars != null
              && vars.stream()
                  .filter(variableData -> variableData.variable.equals(input))
                  .findFirst()
                  .map(variableData -> variableData.isArray)
                  .orElse(false);
      ...
      PTXVariablePrefix typePrefix =
          Arrays.stream(PTXVariablePrefix.values())
              .filter(tp -> tp.getType().equals(input.getPlatformKind().name().toLowerCase()))
              .findFirst()
      ...
      String indexValue =
          isArray
              ? arraylocalIndexes.get(ptxKind).toString()
              : String.valueOf(localIndexes.get(ptxKind));
  ...
  public static class PTXUnaryOp extends PTXOp {
    ...
    public static final PTXUnaryOp CVT_FLOAT_RNE =
        new PTXUnaryOp(CONVERT, false, ROUND_NEAREST_EVEN);
    public static final PTXUnaryOp CVT_FLOAT = new PTXUnaryOp(CONVERT, false, null);
    public static final PTXUnaryOp CVT_INT_RTZ =
        new PTXUnaryOp(CONVERT, false, ROUND_TOWARD_ZERO_INTEGER);
  ...
  public static class PTXUnaryIntrinsic extends PTXUnaryOp {
    // @formatter:off
    public static final PTXUnaryIntrinsic BARRIER_SYNC =
        new PTXUnaryIntrinsic("barrier.sync", null, false, false);
    ...
    public static final PTXUnaryIntrinsic CEIL =
        new PTXUnaryIntrinsic("cvt", ROUND_POSITIVE_INFINITY_INTEGER);
    ...
    public static final PTXUnaryIntrinsic FLOAT_FLOOR =
        new PTXUnaryIntrinsic(CONVERT, ROUND_NEGATIVE_INFINITY_INTEGER, true, false);

    public static final PTXUnaryIntrinsic POPCOUNT =
        new PTXUnaryIntrinsic("popc") {
          @Override
    ...
    protected PTXUnaryIntrinsic(
        String opcode, String roundingMode, boolean isTyped, boolean isWeaklyTyped) {
  ...
  public static class PTXBinaryTemplate extends PTXBinaryOp {
    ...
    public static final PTXBinaryTemplate NEW_LOCAL_FLOAT_ARRAY =
        new PTXBinaryTemplate("local memory array float", ".local .f32 %s[%s]");
    public static final PTXBinaryTemplate NEW_LOCAL_INT_ARRAY =
        new PTXBinaryTemplate("local memory array int", ".local .s32 %s[%s]");
    public static final PTXBinaryTemplate NEW_LOCAL_DOUBLE_ARRAY =
        new PTXBinaryTemplate("local memory array double", ".local .f64 %s[%s]");
    public static final PTXBinaryTemplate NEW_LOCAL_LONG_ARRAY =
        new PTXBinaryTemplate("local memory array long", ".local .s64 %s[%s]");
    public static final PTXBinaryTemplate NEW_LOCAL_SHORT_ARRAY =
        new PTXBinaryTemplate("local memory array short", ".local .s16 %s[%s]");
    public static final PTXBinaryTemplate NEW_LOCAL_CHAR_ARRAY =
        new PTXBinaryTemplate("local memory array char", ".local .u16 %s[%s]");
    public static final PTXBinaryTemplate NEW_LOCAL_BYTE_ARRAY =
        new PTXBinaryTemplate("local memory array byte", ".local .s8 %s[%s]");

    public static final PTXBinaryTemplate LOCAL_FLOAT_ARRAY_PTR_COPY =
        new PTXBinaryTemplate("local pointer copy array float", "ld.local.f32 %s, [%s]");
    public static final PTXBinaryTemplate LOCAL_INT_ARRAY_PTR_COPY =
        new PTXBinaryTemplate("local pointer copy array int", "ld.local.s32 %s, [%s]");
    public static final PTXBinaryTemplate LOCAL_DOUBLE_ARRAY_PTR_COPY =
        new PTXBinaryTemplate("local pointer copy array double", "ld.local.f64 %s, [%s]");
    public static final PTXBinaryTemplate LOCAL_LONG_ARRAY_PTR_COPY =
        new PTXBinaryTemplate("local pointer copy array long", "ld.local.s64 %s, [%s]");
    public static final PTXBinaryTemplate LOCAL_SHORT_ARRAY_PTR_COPY =
        new PTXBinaryTemplate("local pointer copy array short", "ld.local.s16 %s, [%s]");
    public static final PTXBinaryTemplate LOCAL_CHAR_ARRAY_PTR_COPY =
        new PTXBinaryTemplate("local pointer copy array char", "ld.local.u16 %s, [%s]");
    public static final PTXBinaryTemplate LOCAL_BYTE_ARRAY_PTR_COPY =
        new PTXBinaryTemplate("local pointer copy array byte", "ld.local.s8 %s, [%s]");

    public static final PTXBinaryTemplate NEW_SHARED_FLOAT_ARRAY =
        new PTXBinaryTemplate("shared memory array float", ".shared .f32 %s[%s]");
    public static final PTXBinaryTemplate NEW_SHARED_INT_ARRAY =
        new PTXBinaryTemplate("shared memory array int", ".shared .s32 %s[%s]");
    public static final PTXBinaryTemplate NEW_SHARED_DOUBLE_ARRAY =
        new PTXBinaryTemplate("shared memory array double", ".shared .f64 %s[%s]");
    public static final PTXBinaryTemplate NEW_SHARED_LONG_ARRAY =
        new PTXBinaryTemplate("shared memory array long", ".shared .s64 %s[%s]");
    public static final PTXBinaryTemplate NEW_SHARED_SHORT_ARRAY =
        new PTXBinaryTemplate("shared memory array short", ".shared .s16 %s[%s]");
    public static final PTXBinaryTemplate NEW_SHARED_CHAR_ARRAY =
        new PTXBinaryTemplate("shared memory array char", ".shared .u16 %s[%s]");
    public static final PTXBinaryTemplate NEW_SHARED_BYTE_ARRAY =
        new PTXBinaryTemplate("shared memory array byte", ".shared .s8 %s[%s]");

    public static final PTXBinaryTemplate NEW_LOCAL_BIT32_ARRAY =
        new PTXBinaryTemplate("local memory array bit 32", ".local .b32 %s[%s]");
    public static final PTXBinaryTemplate NEW_ALIGNED_PARAM_BYTE_ARRAY =
        new PTXBinaryTemplate("aligned param memory array byte", ".param .align 8 .b8 %s[%s]");
