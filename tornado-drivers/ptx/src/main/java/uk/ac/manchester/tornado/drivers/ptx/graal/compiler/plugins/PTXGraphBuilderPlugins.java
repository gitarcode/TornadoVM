...
public class PTXGraphBuilderPlugins {
    ...
    longReg.register(
        new InvocationPlugin("bitCount", Long.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Int,
                b.append(PTXIntUnaryIntrinsicNode.create(value, POPCOUNT, JavaKind.Long)));
            return true;
          }
        });
    ...
    intReg.register(
        new InvocationPlugin("bitCount", Integer.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Int,
                b.append(PTXIntUnaryIntrinsicNode.create(value, POPCOUNT, JavaKind.Int)));
            return true;
          }
        });
  }
  ...
  private static void registerIntLocalArray(
    ...
    r.register(
        new InvocationPlugin("allocateIntLocalArray", InvocationPlugin.Receiver.class, int.class) {
          @Override
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
            ...
            LocalArrayNode localArrayNode =
                new LocalArrayNode(PTXArchitecture.sharedSpace, elementType, constantNode);
  ...
  private static void registerLongLocalArray(
      Registration r, JavaKind returnedJavaKind, JavaKind elementType) {
    r.register(
        new InvocationPlugin("allocateLongLocalArray", InvocationPlugin.Receiver.class, int.class) {
          @Override
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
  ...
  private static void registerFloatLocalArray(
    ...
    r.register(
        new InvocationPlugin(
            "allocateFloatLocalArray", InvocationPlugin.Receiver.class, int.class) {
          @Override
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
  ...
  private static void registerDoubleLocalArray(
    ...
    r.register(
        new InvocationPlugin(
            "allocateDoubleLocalArray", InvocationPlugin.Receiver.class, int.class) {
          @Override
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
    ...
    r.register(
        new InvocationPlugin("signum", Float.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Float,
                b.append(PTXFPUnaryIntrinsicNode.create(value, SIGN, JavaKind.Float)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("signum", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(PTXFPUnaryIntrinsicNode.create(value, SIGN, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("tan", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(PTXFPUnaryIntrinsicNode.create(value, TAN, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("tanh", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(PTXFPUnaryIntrinsicNode.create(value, TANH, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("atan", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(PTXFPUnaryIntrinsicNode.create(value, ATAN, JavaKind.Double)));
            return true;
          }
        });
