...
public final class PTXVectorPlugins {
  ...
  public static void registerPlugins(final Plugins ps, final InvocationPlugins plugins) {
    ...
    registerVectorCollectionsPlugins(
        plugins, PTXKind.VECTORFLOAT16, FloatArray.class, Float16.class);
    ...
    registerVectorCollectionsPlugins(
        plugins, PTXKind.VECTORDOUBLE2, DoubleArray.class, Double2.class);
    registerVectorCollectionsPlugins(
        plugins, PTXKind.VECTORDOUBLE3, DoubleArray.class, Double3.class);
    registerVectorCollectionsPlugins(
        plugins, PTXKind.VECTORDOUBLE4, DoubleArray.class, Double4.class);
    registerVectorCollectionsPlugins(
        plugins, PTXKind.VECTORDOUBLE8, DoubleArray.class, Double8.class);
    registerVectorCollectionsPlugins(
        plugins, PTXKind.VECTORDOUBLE16, DoubleArray.class, Double16.class);

    registerVectorCollectionsPlugins(
        plugins, PTXKind.VECTORHALF2, HalfFloatArray.class, Half2.class);
    registerVectorCollectionsPlugins(
        plugins, PTXKind.VECTORHALF3, HalfFloatArray.class, Half3.class);
    registerVectorCollectionsPlugins(
        plugins, PTXKind.VECTORHALF4, HalfFloatArray.class, Half4.class);
    registerVectorCollectionsPlugins(
        plugins, PTXKind.VECTORHALF8, HalfFloatArray.class, Half8.class);
    registerVectorCollectionsPlugins(
        plugins, PTXKind.VECTORHALF16, HalfFloatArray.class, Half16.class);

    registerVectorCollectionsPlugins(
        plugins, PTXKind.MATRIX2DFLOAT4, FloatArray.class, Float4.class);
    registerVectorCollectionsPlugins(
        plugins, PTXKind.MATRIX3DFLOAT4, FloatArray.class, Float4.class);
    registerVectorCollectionsPlugins(
        plugins, PTXKind.MATRIX4X4FLOAT, FloatArray.class, Float4.class);
  ...
  private static VectorValueNode resolveReceiver(
      GraphBuilderContext b, PTXKind vectorKind, ValueNode thisObject) {
  ...
  private static VectorValueNode resolveReceiver(
      GraphBuilderContext b, PTXKind vectorKind, Receiver receiver) {
  ...
  private static void registerVectorPlugins(
        ...
        new InvocationPlugin("get", Receiver.class, int.class) {
          ...
          public boolean apply(
            ...
            final VectorLoadElementNode loadElement =
                new VectorLoadElementNode(vectorKind.getElementKind(), receiver.get(), laneId);
    ...
    r.register(
        new InvocationPlugin("set", Receiver.class, vectorKind.getJavaClass()) {
          @Override
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
            ...
            if (receiver.get() instanceof ParameterNode) {
              ...
              final VectorStoreGlobalMemory store =
                  new VectorStoreGlobalMemory(vectorKind, address, value);
    ...
    r.register(
        new InvocationPlugin("add", Receiver.class, declaringClass, declaringClass) {
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
              Receiver reciever,
    ...
    r.register(
        new InvocationPlugin("sub", Receiver.class, declaringClass, declaringClass) {
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
              Receiver reciever,
    ...
    r.register(
        new InvocationPlugin("mult", Receiver.class, declaringClass, declaringClass) {
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
              Receiver receiver,
    ...
    r.register(
        new InvocationPlugin("div", Receiver.class, declaringClass, declaringClass) {
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
              Receiver receiver,
          ...
          if (stampPair.getTrustedStamp() instanceof ObjectStamp) {
            ...
            if (objStamp.type().getAnnotation(Vector.class) != null) {
              ...
              return new ParameterNode(
                  index, StampPair.createSingle(PTXStampFactory.getStampFor(kind)));
            }
          }
          return null;
        });
