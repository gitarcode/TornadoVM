...
public class PTXAssemblerConstants {
  ...
  public static String VPRINTF_PROTOTYPE =
      ".extern .func (.param .b32 status) vprintf (.param .b64 format, .param .b64 valist);";
  ...
  /**
   * This name is used to represent the mandatory argument for the kernel context. This buffer
   * stores the thread size information in the case of using a Grid.
   */
  public static final String KERNEL_CONTEXT_NAME = "kernel_context";

  /**
   * This name represents the argument for the PTX kernel when developers make use of the TornadoVM
   * {@link uk.ac.manchester.tornado.api.KernelContext} API. The name is just a symbolic
   * representation of the parameter, and it is not intended to be used inside the kernel.
   */
  ...
  /**
   * This constant number corresponds to the calculation of the (pi/180) number, which is used to
