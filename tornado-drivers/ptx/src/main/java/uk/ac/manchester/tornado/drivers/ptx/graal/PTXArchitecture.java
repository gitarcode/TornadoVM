...
public class PTXArchitecture extends Architecture {
    ...
    public String getDeclaration() {
      if (alignment != 0) {
        return String.format(
            ".param .%s .ptr .global .align %s %s", getLirKind().toString(), alignment, name);
      } else {
  ...
  public static class PTXMemoryBase extends PTXRegister {
     ...
     *
     * @param memorySpace The {@link PTXMemorySpace} to associate with this memory base.
     */
  ...
  public static class PTXBuiltInRegister extends Variable {
     ...
     *
     * @param name The name of the built-in register.
     */
      ...
      switch (dim) {
        ...
        default:
          throw new TornadoBailoutRuntimeException(
              String.format("[ERROR] Too many dimensions: %d", dim));
      }
    }
  }
}
