...
public abstract class PTXArrayWrapper<T> implements XPUBuffer {
  ...
  protected abstract int enqueueReadArrayData(
      long executionPlanId, long address, long bytes, T value, long hostOffset, int[] waitEvents);
  ...
  protected abstract void writeArrayData(
      long executionPlanId, long address, long bytes, T value, int hostOffset, int[] waitEvents);
