...
public class PTXLIRStmt {
  ...
  public static class DivideHalfFloatStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<DivideHalfFloatStmt> TYPE =
        LIRInstructionClass.create(DivideHalfFloatStmt.class);

    @Use protected Value dividend;
    @Use protected Value divisor;
    @Def protected Value dividendFloat;
    @Def protected Value divisorFloat;
    @Def protected Value floatResult;
    @Def protected Value halfFloatResult;

    public DivideHalfFloatStmt(
        Value dividend,
        Value divisor,
        Value dividendFloat,
        Value divisorFloat,
        Value floatResult,
        Value halfFloatResult) {
      super(TYPE);
    ...
    public void emitCode(PTXCompilationResultBuilder crb, PTXAssembler asm) {
      ...
      asm.emit(
          CONVERT_RN
              + DOT
              + halfFloatResult.getPlatformKind()
              + DOT
              + floatResult.getPlatformKind());
      asm.emitSymbol(SPACE);
  ...
  public static class ConvertHalfFloatStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<ConvertHalfFloatStmt> TYPE =
        LIRInstructionClass.create(ConvertHalfFloatStmt.class);

    @Def protected Value halfFloatVariable;
    @Use protected Value input;
    @Def protected Value intermediate;
    ...
    public void emitCode(PTXCompilationResultBuilder crb, PTXAssembler asm) {
      ...
      asm.emit(
          CONVERT_RN
              + DOT
              + halfFloatVariable.getPlatformKind()
              + DOT
              + intermediate.getPlatformKind());
      asm.emitSymbol(SPACE);
  ...
  public static class VectorAddHalfStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<VectorAddHalfStmt> TYPE =
        LIRInstructionClass.create(VectorAddHalfStmt.class);
  ...
  public static class VectorSubHalfStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<VectorSubHalfStmt> TYPE =
        LIRInstructionClass.create(VectorSubHalfStmt.class);
  ...
  public static class VectorMultHalfStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<VectorMultHalfStmt> TYPE =
        LIRInstructionClass.create(VectorMultHalfStmt.class);
  ...
  public static class LocalMemoryAccessStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<LocalMemoryAccessStmt> TYPE =
        LIRInstructionClass.create(LocalMemoryAccessStmt.class);
    ...
    public static boolean arrayBaseConversion(PTXKind lhsKind, PTXKind rhsKind) {
      if ((rhsKind.isF32() || rhsKind.isS32() || rhsKind.isF64() || rhsKind.isS64())
          && lhsKind.isU32()) {
        return true;
      }
    ...
    public void emitCode(PTXCompilationResultBuilder crb, PTXAssembler asm) {
      ...
      if (arrayBaseConversion(lhsKind, rhsKind)) {
        ...
        if ((lhsKind.isFloating() || rhsKind.isFloating())
            && getFPURoundingMode(lhsKind, rhsKind) != null) {
  ...
  public static class ConvertAddressStmt extends AbstractInstruction {
    public static final LIRInstructionClass<ConvertAddressStmt> TYPE =
        LIRInstructionClass.create(ConvertAddressStmt.class);

    @Use private final Value src;
    @Use private final Value dest;
    @Use private final PTXMemorySpace srcMemorySpace;
  ...
  public static class LoadStmt extends AbstractInstruction {
    ...
    @Use protected Variable dest;

    @Use PTXUnary.MemoryAccess address;

    @Use PTXNullaryOp loadOp;
  ...
  public static class HalfFloatLoadStmt extends AbstractInstruction {
    public static final LIRInstructionClass<HalfFloatLoadStmt> TYPE =
        LIRInstructionClass.create(HalfFloatLoadStmt.class);
  ...
  public static class VectorLoadStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<VectorLoadStmt> TYPE =
        LIRInstructionClass.create(VectorLoadStmt.class);

    @Def protected Variable dest;
    @Use protected PTXUnary.MemoryAccess address;
    ...
    public void emitCode(PTXCompilationResultBuilder crb, PTXAssembler asm) {
      ...
      for (int i = 0; i < vectorSplitData.vectorNames.length; i++) {
        ...
        asm.emitSymbol(DOT);
        asm.emit(
            vectorSplitData.fullUnwrapVector
                ? vectorSplitData.newKind.toString()
                : vectorSplitData.newKind.getElementKind().toString());
        asm.emitSymbol(TAB);
  ...
  public static class HalfFloatStoreStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<HalfFloatStoreStmt> TYPE =
        LIRInstructionClass.create(HalfFloatStoreStmt.class);
  ...
  public static class VectorStoreStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<VectorStoreStmt> TYPE =
        LIRInstructionClass.create(VectorStoreStmt.class);

    @Def protected Variable source;
    @Use protected PTXUnary.MemoryAccess address;
  ...
  public static class ConditionalStatement extends AbstractInstruction {
    public static final LIRInstructionClass<ConditionalStatement> TYPE =
        LIRInstructionClass.create(ConditionalStatement.class);

    @Use private final AbstractInstruction instruction;

    @Use private final Variable guard;

    @Use private final boolean isNegated;
  ...
  public static class PrintfStringDeclarationStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<PrintfStringDeclarationStmt> TYPE =
        LIRInstructionClass.create(PrintfStringDeclarationStmt.class);

    @Use private final Value stringValue;
  ...
  public static class PrivateArrayCopyStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<PrivateArrayCopyStmt> TYPE =
        LIRInstructionClass.create(PrivateArrayCopyStmt.class);
    @Use protected Value index;
    @Use protected Value arrayToBeCopied;
    @Use protected Value offsetedIndex;
    @Use protected Value baseAddress;
    @Use protected Value offset;

    public PrivateArrayCopyStmt(
        Value index, Value arrayToBeCopied, Value offsetedIndex, Value addResult, Value offset) {
      super(TYPE);
      this.index = index;
