...
public class PTXLoweringProvider extends DefaultJavaLoweringProvider {
  ...
  /**
   * {@link PTXLoweringProvider#gpuSnippet} is set during the lowering phase. Therefore, this method
  ...
  private void lowerLocalNewArray(
    ...
    localArrayNode =
        graph.addWithoutUnique(
            new LocalArrayNode(PTXArchitecture.sharedSpace, newArray.elementType(), newLengthNode));
  ...
  private void lowerPrivateNewArray(
    ...
    fixedArrayNode =
        graph.addWithoutUnique(
            new FixedArrayNode(PTXArchitecture.localSpace, newArray.elementType(), newLengthNode));
  ...
  public void lowerStoreIndexedNode(StoreIndexedNode storeIndexed, LoweringTool tool) {
    ...
    AbstractWriteNode memoryWrite =
        createMemWriteNode(elementKind, writeValue, array, address, graph, storeIndexed);
