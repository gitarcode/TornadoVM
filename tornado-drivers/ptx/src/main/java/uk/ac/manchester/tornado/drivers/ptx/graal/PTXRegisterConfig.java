...
public class PTXRegisterConfig implements RegisterConfig {
  private static final Register DUMMY = new Register(0, 0, "dummy", PTXArchitecture.PTX_ABI);
  private static final RegisterArray EMPTY = new RegisterArray(new Register[0]);
  ...
  public CallingConvention getCallingConvention(
      CallingConvention.Type type, JavaType jt, JavaType[] jts, ValueKindFactory<?> vkf) {
