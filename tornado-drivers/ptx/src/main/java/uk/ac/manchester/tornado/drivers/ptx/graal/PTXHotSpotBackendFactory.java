...
public class PTXHotSpotBackendFactory {
  ...
  private static final PTXCompilerConfiguration compilerConfiguration =
      new PTXCompilerConfiguration();
  private static final PTXAddressLowering addressLowering = new PTXAddressLowering();

  public static PTXBackend createJITCompiler(
  ...
  protected static GraphBuilderConfiguration.Plugins createGraphBuilderPlugins(
    ...
    GraphBuilderConfiguration.Plugins plugins =
        new GraphBuilderConfiguration.Plugins(invocationPlugins);
