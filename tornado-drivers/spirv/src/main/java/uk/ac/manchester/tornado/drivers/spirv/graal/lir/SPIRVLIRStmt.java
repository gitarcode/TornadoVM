...
public class SPIRVLIRStmt {
  ...
  public static class AssignStmt extends AbstractInstruction {
    ...
    protected void emitCode(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      ...
      Logger.traceCodeGen(
          Logger.BACKEND.SPIRV, "emit Assignment : " + lhs + " = " + rhs.getClass());
      ...
      if (isConstant) {
        inputExpressionId =
            asm.lookUpConstant(
                ((ConstantValue) this.rhs).getConstant().toValueString(),
                (SPIRVKind) rhs.getPlatformKind());
      } else {
        ...
        asm.currentBlockScope()
            .add(
                new SPIRVOpStore( //
                    ...
                    new SPIRVOptionalOperand<>(
                        SPIRVMemoryAccess.Aligned(
                            new SPIRVLiteralInteger(lhs.getPlatformKind().getSizeInBytes())) //
                        )));
      }
  ...
  public static class IgnorableAssignStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<IgnorableAssignStmt> TYPE =
        LIRInstructionClass.create(IgnorableAssignStmt.class);
  ...
  public static class StoreFunctionParameter extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<StoreFunctionParameter> TYPE =
        LIRInstructionClass.create(StoreFunctionParameter.class);
    ...
    protected void emitCode(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      ...
      Logger.traceCodeGen(
          Logger.BACKEND.SPIRV, "emit StoreFunctionParameter: " + lhs + " = " + rhs);
  ...
  public static class AssignStmtWithLoad extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<AssignStmtWithLoad> TYPE =
        LIRInstructionClass.create(AssignStmtWithLoad.class);
    ...
    protected void emitCode(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      ...
      if (rhs instanceof ConstantValue) {
        ...
        loadId =
            asm.lookUpConstant(
                constantValue.getConstant().toValueString(), (SPIRVKind) rhs.getPlatformKind());
      } else {
      ...
      asm.currentBlockScope()
          .add(
              new SPIRVOpStore( //
                  ...
                  new SPIRVOptionalOperand<>(
                      SPIRVMemoryAccess.Aligned(
                          new SPIRVLiteralInteger(kindLHS.getSizeInBytes())) //
                      )));
  ...
  public static class PassValuePhi extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<PassValuePhi> TYPE =
        LIRInstructionClass.create(PassValuePhi.class);
  ...
  public static class OpPhiStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<OpPhiStmt> TYPE =
        LIRInstructionClass.create(OpPhiStmt.class);
    ...
    @Use protected boolean checkDuplicate;
    ...
    public OpPhiStmt(
        ...
        Value previousValue,
        String firstSuccessorBlockName,
        String previousBlockName,
        Map<AllocatableValue, SPIRVId> phiMap,
        Map<AllocatableValue, AllocatableValue> phiTrace) {
      this(
          lhs,
          previousValue,
          firstSuccessorBlockName,
          previousBlockName,
          phiMap,
          phiTrace,
          false,
    ...
    public OpPhiStmt(
        ...
        List<SPIRVNodeLIRBuilder.PhiHolder> phiHolder) {
      super(TYPE);
      this.lhs = lhs;
    ...
    private SPIRVId getPreviousId(SPIRVAssembler asm, Value var) {
      if (var instanceof ConstantValue) {
        ...
        return asm.lookUpConstant(
            constantValue.getConstant().toValueString(), (SPIRVKind) var.getPlatformKind());
      } else {
    ...
    private SPIRVId getNewId(SPIRVAssembler asm) {
      if (forwardedId) {
        ...
        if (forwardValue instanceof ConstantValue) {
          ...
          return asm.lookUpConstant(
              constantValue.getConstant().toValueString(),
              (SPIRVKind) forwardValue.getPlatformKind());
        } else {
    ...
    private SPIRVId checkIdDoesNotCycle(SPIRVAssembler asm, SPIRVId previousID, SPIRVId newID) {
      ...
      if (previousID.equals(newID)) {
        ...
        if (valuePhiPos01 instanceof ConstantValue) {
          ...
          return asm.lookUpConstant(
              constantValue.getConstant().toValueString(),
              (SPIRVKind) valuePhiPos01.getPlatformKind());
        } else {
    ...
    /**
     * Usually we have two operands. However, when merging results from switch statements we might
     * have multiple Phi Values to be merged. In this case, all branches (IDs) have been already
     * generated, so they are expected to be found in the ASM lookup tables.
     *
     * @param asm {@link SPIRVAssembler} Assembler
     * @param previousID {@link SPIRVId} Previous ID in SPIRVId format
     * @param previousBranch {@link SPIRVId} of the previous branch
     * @param newID {@link SPIRVId} of the new ID
     * @param currentBranch {@link SPIRVId} basic block of the new ID
     * @return {@link SPIRVMultipleOperands<SPIRVPairIdRefIdRef>}
     */
    private SPIRVMultipleOperands<SPIRVPairIdRefIdRef> composeOperands(
        SPIRVAssembler asm,
        SPIRVId previousID,
        SPIRVId previousBranch,
        SPIRVId newID,
        SPIRVId currentBranch) {
      ...
      if (phiHolders != null && phiHolders.size() > 2) {
        ...
        operands =
            new SPIRVMultipleOperands<>(
                new SPIRVPairIdRefIdRef(previousID, previousBranch),
                new SPIRVPairIdRefIdRef(newID, currentBranch));
      }
      return operands;
    }
    ...
    protected void emitCode(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      ...
      SPIRVMultipleOperands<SPIRVPairIdRefIdRef> operands =
          composeOperands(asm, previousID, previousBranch, newID, currentBranch);
  ...
  public static class ASSIGNParameter extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<ASSIGNParameter> TYPE =
        LIRInstructionClass.create(ASSIGNParameter.class);
    ...
    /**
     * Emit the following SPIR-V structure: <code>
     * OpStore <address> <value> Aligned <alignment>
     * </code>
     *
     * @param crb {@link SPIRVCompilationResultBuilder}
      ...
      asm.currentBlockScope()
          .add(
              new SPIRVOpStore( //
                  ...
                  idExpression, //
                  new SPIRVOptionalOperand<>(
                      SPIRVMemoryAccess.Aligned(new SPIRVLiteralInteger(alignment))) //
                  ));
  ...
  public static class ASSIGNParameterWithNoStore extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<ASSIGNParameterWithNoStore> TYPE =
        LIRInstructionClass.create(ASSIGNParameterWithNoStore.class);

    @Def private AllocatableValue lhs;
    @Use private Value rhs;
     ...
     *
     * <p>Loads the stack frame. This version optimizes Loads/Stores.
     *
     * @param crb {@link SPIRVCompilationResultBuilder}
     * @param asm {@link SPIRVAssembler}
     */
  ...
  public static class ASSIGNParameterWithNoStoreNewMemoryModel extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<ASSIGNParameterWithNoStoreNewMemoryModel> TYPE =
        LIRInstructionClass.create(ASSIGNParameterWithNoStoreNewMemoryModel.class);
  ...
  public static class ASSIGNIndexedParameter extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<ASSIGNIndexedParameter> TYPE =
        LIRInstructionClass.create(ASSIGNIndexedParameter.class);
        ...
        asm.currentBlockScope()
            .add(
                new SPIRVOpStore( //
                    ...
                    convertId, //
                    new SPIRVOptionalOperand<>(
                        SPIRVMemoryAccess.Aligned(new SPIRVLiteralInteger(4))) //
                    ));
        asm.registerLIRInstructionValue(lhs, parameterID);
      }
    }
  ...
  public static class ExprStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<ExprStmt> TYPE =
        LIRInstructionClass.create(ExprStmt.class);
  ...
  public static class LoadStmt extends AbstractInstruction {
    ...
    @Use protected SPIRVAddressCast cast;

    @Use protected MemoryAccess base;
    ...
    private SPIRVId emitLoadIfNeeded(
        SPIRVAssembler asm, SPIRVId addressToLoad, SPIRVId idKindLoad) {
      if (TornadoOptions.OPTIMIZE_LOAD_STORE_SPIRV) {
        ...
        asm.currentBlockScope()
            .add(
                new SPIRVOpLoad( //
                    ...
                    new SPIRVOptionalOperand<>(
                        SPIRVMemoryAccess.Aligned(
                            new SPIRVLiteralInteger(SPIRVKind.OP_TYPE_INT_64.getByteCount())))));
        return idLoad;
      }
    }
        ...
        asm.currentBlockScope()
            .add(
                new SPIRVOpStore( //
                    ...
                    new SPIRVOptionalOperand<>(
                        SPIRVMemoryAccess.Aligned(
                            new SPIRVLiteralInteger(cast.getSPIRVPlatformKind().getByteCount())) //
                        )));
      }
    }
    ...
    public void emitCode(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      ...
      SPIRVId ptrCrossGroup =
          asm.primitives.getPtrToCrossWorkGroupPrimitive((SPIRVKind) result.getPlatformKind());
  ...
  public static class LoadVectorStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<LoadVectorStmt> TYPE =
        LIRInstructionClass.create(LoadVectorStmt.class);
    ...
    public LoadVectorStmt(
        AllocatableValue result, SPIRVAddressCast cast, MemoryAccess memoryRegion) {
      super(TYPE);
      this.result = result;
      this.cast = cast;
      this.base = memoryRegion;
     ...
     *
     * <p>Then the SPIR-V Optimizer is not enabled: <code>
    ...
    public void emitCode(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      ...
      SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic builtIn =
          SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.VLOADN;
      ...
      SPIRVMultipleOperands operandsIntrinsic =
          new SPIRVMultipleOperands(
              baseIndex,
              idLongToPtr,
              new SPIRVLiteralInteger(cast.getSPIRVPlatformKind().getVectorLength()));
  ...
  public static class StoreStmt extends AbstractInstruction {
    ...
    protected void emitCode(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      Logger.traceCodeGen(
          Logger.BACKEND.SPIRV, "emit StoreStmt in address: " + cast + " <- " + rhs);
          ...
          asm.currentBlockScope()
              .add(
                  new SPIRVOpLoad( //
                      ...
                      new SPIRVOptionalOperand<>(
                          SPIRVMemoryAccess.Aligned(
                              new SPIRVLiteralInteger(rhs.getPlatformKind().getSizeInBytes()))) //
                      ));
          value = loadID;
        }
      }
  ...
  public static class StoreVectorStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<StoreVectorStmt> TYPE =
        LIRInstructionClass.create(StoreVectorStmt.class);
    ...
    protected void emitCode(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      ...
      SPIRVKind vectorElementKind =
          ((SPIRVKind) cast.getLIRKind().getPlatformKind()).getElementKind();
      SPIRVId ptrCrossGroup = asm.primitives.getPtrToCrossWorkGroupPrimitive(vectorElementKind);
      ...
      Logger.traceCodeGen(
          Logger.BACKEND.SPIRV, "emit StoreVectorStmt in address: " + cast + " <- " + rhs);

      SPIRVId set = asm.getOpenclImport();
      SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic builtIn =
          SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.VSTOREN;
      SPIRVId baseIndex = asm.lookUpConstant("0", SPIRVKind.OP_TYPE_INT_64);

      SPIRVLiteralExtInstInteger intrinsic =
          new SPIRVLiteralExtInstInteger(builtIn.getValue(), builtIn.getName());
      SPIRVMultipleOperands operandsIntrinsic =
          new SPIRVMultipleOperands(value, baseIndex, ptrConversionId);
  ...
  public static class StoreVectorCollectionStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<StoreVectorCollectionStmt> TYPE =
        LIRInstructionClass.create(StoreVectorCollectionStmt.class);

    @Use protected Value rhs;

    @Use protected SPIRVAddressCast cast;

    @Use protected SPIRVUnary.AbstractMemoryAccess address;

    @Use protected Value index;

    public StoreVectorCollectionStmt(
        SPIRVAddressCast cast, SPIRVUnary.AbstractMemoryAccess address, Value rhs, Value index) {
      super(TYPE);
      this.cast = cast;
      this.address = address;
      this.rhs = rhs;
    ...
    protected void emitCode(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      ...
      asm.currentBlockScope()
          .add(new SPIRVOpInBoundsPtrAccessChain(re, ptrConversionId, addressToLoad, element, op));
      asm.registerLIRInstructionValue(cast, ptrConversionId);
      ...
      asm.currentBlockScope()
          .add(new SPIRVOpPtrCastToGeneric(ptrGeneric, genericResult, ptrConversionId));

      Logger.traceCodeGen(
          Logger.BACKEND.SPIRV,
          "emit StoreVectorCollectionStmt in address: " + cast + " <- " + rhs);
      ...
      if (index instanceof ConstantValue) {
        baseIndex =
            asm.lookUpConstant(
                ((ConstantValue) this.index).getConstant().toValueString(),
                (SPIRVKind) index.getPlatformKind());
      } else {
      ...
      SPIRVLiteralExtInstInteger intrinsic =
          new SPIRVLiteralExtInstInteger(builtIn.getValue(), builtIn.getName());
      SPIRVMultipleOperands operandsIntrinsic =
          new SPIRVMultipleOperands(value, baseIndex, genericResult);
  ...
  public static class PrivateArrayAllocation extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<PrivateArrayAllocation> TYPE =
        LIRInstructionClass.create(PrivateArrayAllocation.class);

    @Def AllocatableValue allocatableValue;

    @Use private Value privateAllocation;
  ...
  public static class LocalArrayAllocation extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<LocalArrayAllocation> TYPE =
        LIRInstructionClass.create(LocalArrayAllocation.class);

    @Use private Value localArray;
  ...
  public static class StoreIndexedMemAccess extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<StoreIndexedMemAccess> TYPE =
        LIRInstructionClass.create(StoreIndexedMemAccess.class);

    @Use protected Value rhs;

    @Use protected SPIRVUnary.MemoryIndexedAccess memoryIndexedAccess;
    ...
    private boolean isPrivateMemoryAccess() {
      return this.memoryIndexedAccess.getMemoryRegion().getNumber()
          == SPIRVArchitecture.privateSpace.getNumber();
    }

    private boolean isLocalMemoryAccess() {
      return this.memoryIndexedAccess.getMemoryRegion().getNumber()
          == SPIRVArchitecture.localSpace.getNumber();
    }

    private void emitStoreIndexedAccessPrivateMemory(
        SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      Logger.traceCodeGen(
          Logger.BACKEND.SPIRV,
          "emit [Private] IndexedMemAccess in address: " + memoryIndexedAccess + "[ " + rhs + "]");
      ...
      if (rhs instanceof ConstantValue) {
        ...
        privateAccessId =
            asm.lookUpConstant(((ConstantValue) rhs).getConstant().toValueString(), kind);
      } else {
    ...
    private void emitStoreIndexedAccessLocalMemory(
        SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      Logger.traceCodeGen(
          Logger.BACKEND.SPIRV,
          "emit IndexedMemAccess for LOCAL MEMORY in address: "
              + memoryIndexedAccess
              + "[ "
              + rhs
              + "]");
  ...
  protected abstract static class AbstractIndexedLoadAccess extends AbstractInstruction {
    ...
    protected AbstractIndexedLoadAccess(
        LIRInstructionClass<? extends LIRInstruction> c, AllocatableValue result) {
      super(c);
      this.result = result;
    }
  ...
  public static class IndexedLoadMemAccess extends AbstractIndexedLoadAccess {
    ...
    public static final LIRInstructionClass<IndexedLoadMemAccess> TYPE =
        LIRInstructionClass.create(IndexedLoadMemAccess.class);

    @Use protected SPIRVUnary.MemoryIndexedAccess address;
    ...
    protected void emitCode(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      ...
      Logger.traceCodeGen(
          Logger.BACKEND.SPIRV,
          "emit IndexedLoadMemAccess in address: "
              + address
              + "[ "
              + address.getIndex()
              + "]  -- region: "
              + address.getMemoryRegion().getMemorySpace().getName());
  ...
  public static class IndexedLoadMemCollectionAccess extends AbstractIndexedLoadAccess {
    ...
    public static final LIRInstructionClass<IndexedLoadMemCollectionAccess> TYPE =
        LIRInstructionClass.create(IndexedLoadMemCollectionAccess.class);

    @Use protected SPIRVUnary.MemoryIndexedAccess address;

    @Use protected Value offsetIndex;

    public IndexedLoadMemCollectionAccess(
        SPIRVUnary.MemoryIndexedAccess address, AllocatableValue result, Value offset) {
      super(TYPE, result);
      this.address = address;
    ...
    /**
     * This method generates the following structure for TornadoVM collections (e.g., VectorFloat2)
     * <code>
    ...
    protected void emitCode(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      ...
      Logger.traceCodeGen(
          Logger.BACKEND.SPIRV,
          "emit IndexedLoadMemCollectionAccess in address: "
              + address
              + "[ "
              + address.getIndex()
              + "]  -- region: "
      ...
      asm.currentBlockScope()
          .add(new SPIRVOpPtrCastToGeneric(ptrGeneric, genericResult, inBoundsAccess));
      ...
      if (offsetIndex instanceof ConstantValue) {
        baseIndex =
            asm.lookUpConstant(
                ((ConstantValue) offsetIndex).getConstant().toValueString(),
                (SPIRVKind) offsetIndex.getPlatformKind());
      } else {
        baseIndex = asm.lookUpConstant("0", SPIRVKind.OP_TYPE_INT_64);
      }
      ...
      SPIRVMultipleOperands operandsIntrinsic =
          new SPIRVMultipleOperands(
              baseIndex, genericResult, new SPIRVLiteralInteger(spirvKind.getVectorLength()));
