...
public class SPIRVBuiltinTool {
  ...
  public Value genFloatACos(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.ACOS,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatACosh(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.ACOSH,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatACospi(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.ACOSPI,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatCospi(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.COSPI,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatASin(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.ASIN,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatASinpi(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.ASINPI,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatSinpi(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.SINPI,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatATan(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.ATAN,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatATanh(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.ATANH,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatATanpi(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.ATANPI,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatCbrt(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.CBRT,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatCeil(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.CEIL,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatCos(Value input) {
    ...
    SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic intrinsic =
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.COS;
  ...
  public Value genFloatCosh(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.COSH,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatExp(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.EXP,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value generateSign(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.SIGN,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatFloor(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.FLOOR,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatLog(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.LOG,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatSin(Value input) {
    ...
    SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic intrinsic =
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.SIN;
    if (TornadoOptions.ENABLE_NATIVE_FUNCTION) {
  ...
  public Value genFloatTan(Value input) {
    ...
    SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic intrinsic =
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.TAN;
    if (TornadoOptions.ENABLE_NATIVE_FUNCTION) {
  ...
  public Value genFloatTanh(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.TANH,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatRadians(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.RADIANS,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatATan2(Value x, Value y) {
    ...
    return new SPIRVBinary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.ATAN2, LIRKind.combine(x, y), x, y);
  }
  ...
  public Value genFloatMax(Value x, Value y) {
    ...
    return new SPIRVBinary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.FMAX, LIRKind.combine(x, y), x, y);
  }

  public Value genFloatMin(Value x, Value y) {
    Logger.traceBuildLIR(Logger.BACKEND.SPIRV, "gen: min(%s,%s)", x, y);
    return new SPIRVBinary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.FMIN, LIRKind.combine(x, y), x, y);
  }
  ...
  public Value genFloatPow(Value x, Value y) {
    ...
    return new SPIRVBinary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.POW, LIRKind.combine(x, y), x, y);
  }
  ...
  public Value genIntAbs(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.SABS,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
  ...
  public Value genFloatSqrt(Value input) {
    ...
    SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic intrinsic =
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.SQRT;
    if (TornadoOptions.ENABLE_NATIVE_FUNCTION) {
  ...
  public Value genIntMax(Value x, Value y) {
    ...
    return new SPIRVBinary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.SMAX, LIRKind.combine(x, y), x, y);
  }

  public Value genIntMin(Value x, Value y) {
    Logger.traceBuildLIR(Logger.BACKEND.SPIRV, "genMin: min(%s,%s)", x, y);
    return new SPIRVBinary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.SMIN, LIRKind.combine(x, y), x, y);
  }
  ...
  public Value genIntPopcount(Value value) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.POPCOUNT,
        LIRKind.value(value.getPlatformKind()),
        value);
  }
  ...
  public Value genIntClamp(Variable result, Value x, Value y, Value z) {
    ...
    return new SPIRVTernary.TernaryIntrinsic(
        result,
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.SCLAMP,
        LIRKind.combine(x, y, z),
        x,
        y,
        z);
  }
  ...
  public Value genFloatAbs(Value input) {
    ...
    return new SPIRVUnary.Intrinsic(
        SPIRVUnary.Intrinsic.OpenCLExtendedIntrinsic.FABS,
        LIRKind.value(input.getPlatformKind()),
        input);
  }
