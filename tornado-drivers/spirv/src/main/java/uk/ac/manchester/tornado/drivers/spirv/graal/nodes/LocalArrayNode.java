...
public class LocalArrayNode extends FixedNode implements LIRLowerable, MarkLocalArray, MemoryKill {
  ...
  public LocalArrayNode(
      SPIRVArchitecture.SPIRVMemoryBase memoryBase, JavaKind elementType, ConstantNode length) {
  ...
  public void generate(NodeLIRBuilderTool generator) {
    ...
    final SPIRVBinary.LocalArrayAllocation localArray =
        new SPIRVBinary.LocalArrayAllocation(lirKind, resultArray, lengthValue);
    Logger.traceBuildLIR(
        Logger.BACKEND.SPIRV, "Local Array Allocation: " + resultArray + " with type: " + lirKind);
