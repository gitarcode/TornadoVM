...
public class SPIRVCompilationResultBuilder extends CompilationResultBuilder {
  ...
  public SPIRVCompilationResultBuilder(
  ...
  private boolean isFalseSuccessorWithLoopEnd(IfNode ifNode, HIRBlock basicBlock) {
    return isCurrentBlockAFalseBranch(ifNode, basicBlock)
        && basicBlock.getEndNode() instanceof LoopEndNode;
  }
   ...
   * LoopExitNode or it is not a control Split (due to nested control-flow).
   *
