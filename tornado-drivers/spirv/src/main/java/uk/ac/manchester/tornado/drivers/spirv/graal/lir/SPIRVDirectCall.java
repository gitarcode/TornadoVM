...
public class SPIRVDirectCall extends SPIRVLIROp {
  ...
  @Def private Value result;

  @Use private Value[] parameters;

  public SPIRVDirectCall(
      DirectCallTargetNode targetNode, Value result, Value[] parameters, LIRFrameState frameState) {
  ...
  public void emit(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
    ...
    Logger.traceCodeGen(
        ...
        "emit OpFunctionCall for method: " + targetNode.targetMethod().getName());
