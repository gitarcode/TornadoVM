...
public class SPIRVVectorAssign {
    ...
    protected SPIRVId getId(Value inputValue, SPIRVAssembler asm, SPIRVKind spirvKind) {
      if (inputValue instanceof ConstantValue) {
        ...
        if (TornadoOptions.OPTIMIZE_LOAD_STORE_SPIRV) {
          ...
          Logger.traceCodeGen(
              Logger.BACKEND.SPIRV, "emit LOAD Variable from AssignVector :" + inputValue);
  ...
  public static class AssignVectorExpr extends AssignVector {
    ...
    private SPIRVId emitCompositeInsertN(
        SPIRVAssembler asm, SPIRVId composite, SPIRVId vectorType, int index) {
    ...
    public void emit(SPIRVCompilationResultBuilder crb, SPIRVAssembler asm) {
      ...
      Logger.traceCodeGen(
          ...
          "emit VectorComposite: " + this + ": " + values.length + getSPIRVPlatformKind());
