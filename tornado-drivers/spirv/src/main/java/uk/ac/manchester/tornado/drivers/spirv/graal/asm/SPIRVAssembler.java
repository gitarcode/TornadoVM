...
public final class SPIRVAssembler extends Assembler {
  ...
  public void emitAttribute(SPIRVCompilationResultBuilder crb) {
    throw new RuntimeException(
        "[Not supported for SPIR-V] FPGA ATTRIBUTES - Check with the OpenCL Backend");
  }
  ...
  /**
   * This method composes a unique name for all labels used. This is important since all methods
   * within the same compilation unit will be in the same file, and SPIR-V requires different names.
   *
   * <p>If we want to return the same names per module, just return the labelName.
   *
  ...
  private SPIRVId createNewOpTypeFunction(SPIRVId returnType, SPIRVId... operands) {
    ...
    module.add(
        new SPIRVOpTypeFunction(
            functionSignature, returnType, new SPIRVMultipleOperands<>(operands)));
  ...
  public void emitEntryPointMainKernel(
      StructuredGraph graph, String kernelName, boolean fp64Capability, boolean fp16Capability) {
    ...
    module.add(
        new SPIRVOpEntryPoint(
            SPIRVExecutionModel.Kernel(),
            mainFunctionID,
            new SPIRVLiteralString(kernelName),
            operands));
  }
  ...
  public SPIRVInstScope emitOpFunction(
      SPIRVId returnType,
      SPIRVId functionID,
      SPIRVId functionPredefinition,
      SPIRVFunctionControl functionControl) {
    if (functionID == null || functionPredefinition == null) {
      throw new RuntimeException(
          "MainFunction or FunctionPre SPIR-V IDs are null. It can't generate correct SPIR-V code");
    }
    functionScope =
        module.add(
            new SPIRVOpFunction(returnType, functionID, functionControl, functionPredefinition));
    return functionScope;
  }

  public void emitParameterFunction(
      SPIRVId typeID, SPIRVId parameterId, SPIRVInstScope functionScope) {
  ...
  public SPIRVId emitConstantValue(SPIRVKind type, String valueConstant) {
    ...
    switch (type) {
      case OP_TYPE_INT_8, OP_TYPE_INT_16, OP_TYPE_INT_32 ->
          module.add(
              new SPIRVOpConstant(
                  typeID,
                  newConstantId,
                  new SPIRVContextDependentInt(
                      BigInteger.valueOf(Integer.parseInt(valueConstant)))));
      case OP_TYPE_INT_64 ->
          module.add(
              new SPIRVOpConstant(
                  typeID,
                  newConstantId,
                  new SPIRVContextDependentLong(
                      BigInteger.valueOf(Integer.parseInt(valueConstant)))));
      case OP_TYPE_FLOAT_16 ->
          module.add(
              new SPIRVOpConstant(
                  typeID,
                  newConstantId,
                  new SPIRVContextDependentHalfFloat(
                      Float.floatToFloat16(Float.parseFloat(valueConstant)))));
      case OP_TYPE_FLOAT_32 ->
          module.add(
              new SPIRVOpConstant(
                  typeID,
                  newConstantId,
                  new SPIRVContextDependentFloat(Float.parseFloat(valueConstant))));
      case OP_TYPE_FLOAT_64 ->
          module.add(
              new SPIRVOpConstant(
                  typeID,
                  newConstantId,
                  new SPIRVContextDependentDouble(Double.parseDouble(valueConstant))));
    ...
    currentBlockScope()
        .add(
            new SPIRVOpLoad( //
                ...
                frameId, //
                new SPIRVOptionalOperand<>(
                    SPIRVMemoryAccess.Aligned(new SPIRVLiteralInteger(8))) //
                ));
  ...
  public SPIRVId registerNewMethod(String methodName) {
    ...
    module.add(
        new SPIRVOpDecorate(
            functionToCall,
            SPIRVDecoration.LinkageAttributes(
                new SPIRVLiteralString(methodName), SPIRVLinkageType.Export())));
  ...
  public SPIRVId emitDecorateOpenCLBuiltin(SPIRVModule module, SPIRVThreadBuiltIn builtIn) {
    ...
    module.add(
        new SPIRVOpDecorate(
            idSPIRVBuiltin,
            SPIRVDecoration.LinkageAttributes(
                new SPIRVLiteralString(builtIn.getName()), SPIRVLinkageType.Import())));
  ...
  public abstract static class SPIRVBinaryOp extends SPIRVOp {
    ...
    public static final SPIRVBinaryOp INTEGER_LESS_THAN =
        new SPIRVBinaryOpSLessThan("<", "SPIRVOpSLessThan");
    public static final SPIRVBinaryOp INTEGER_EQUALS =
        new SPIRVBinaryOpIEqual("==", "SPIRVBinaryOpIEqual");
    public static final SPIRVBinaryOp INTEGER_BELOW =
        new SPIRVBinaryOpIBelow("<", "SPIRVOpSLessThan");
    ...
    public static final SPIRVBinaryOp FLOAT_LESS_THAN =
        new SPIRVBinaryFORLessThan("<", "SPIRVBinaryFORLessThan");
    public static final SPIRVBinaryOp FLOAT_EQUALS =
        new SPIRVBinaryFOREquals("==", "SPIRVOpFOrdEqual");

    // Bitwise
    public static final SPIRVBinaryOp BITWISE_LEFT_SHIFT =
        new SPIRVBinaryOpLeftShift("<<", "SPIRVOpShiftLeftLogical");
    public static final SPIRVBinaryOp BITWISE_RIGHT_SHIFT =
        new SPIRVBinaryOpRightShift(">>", "SPIRVBinaryOpRightShift");
    public static final SPIRVBinaryOp BITWISE_UNSIGNED_RIGHT_SHIFT =
        new SPIRVBinaryOpUnsignedRightShift(">>", "SPIRVOpShiftRightArithmetic");
    public static final SPIRVBinaryOp BITWISE_AND =
        new SPIRVBinaryOpBitwiseAnd("&", "SPIRVBinaryOpBitwiseAnd");
    public static final SPIRVBinaryOp BITWISE_OR =
        new SPIRVBinaryOpBitwiseOr("&", "SPIRVBinaryOpBitwiseOr");
    public static final SPIRVBinaryOp BITWISE_XOR =
        new SPIRVBinaryOpBitwiseXor("&", "SPIRVBinaryOpBitwiseXor");
    ...
    protected SPIRVBinaryOp(
        String opcode,
        String spirvInstruction,
        boolean checkSameTypes,
        boolean resultWidthCanChange) {
      super(opcode);
      this.spirvInstruction = spirvInstruction;
    ...
    public abstract SPIRVInstruction generateInstruction(
        SPIRVId idResultType, SPIRVId idResult, SPIRVId operand1, SPIRVId operand2);
  }
  ...
  public static class SPIRVBinaryOpIAdd extends SPIRVBinaryOp {
    ...
    @Override
    public SPIRVInstruction generateInstruction(
        SPIRVId idResultType, SPIRVId idResult, SPIRVId operand1, SPIRVId operand2) {
