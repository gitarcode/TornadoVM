...
/**
 * Helper class to measure the elapsed time between two append operations into a LevelZero Command
 * List.
 */
public class LevelZeroTransferTimeStamp implements TimeStamp {
  ...
  public void appendTimeStamp() {
    int result =
        commandList.zeCommandListAppendWriteGlobalTimestamp(
            commandList.getCommandListHandlerPtr(), timeStampDeviceBuffer, null, 0, null);
