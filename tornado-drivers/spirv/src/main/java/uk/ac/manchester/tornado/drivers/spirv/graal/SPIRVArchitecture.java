 ...
 *
 * <p>It contains information such as byte ordering, platform king, memory alignment, etc.
 */
public class SPIRVArchitecture extends Architecture {

  public static final SPIRVMemoryBase kernelContextSpace =
      new SPIRVMemoryBase(0, GLOBAL_REGION_NAME, SPIRVMemorySpace.GLOBAL, SPIRVKind.OP_TYPE_INT_8);
  public static final SPIRVMemoryBase localSpace =
      new SPIRVMemoryBase(1, LOCAL_REGION_NAME, SPIRVMemorySpace.LOCAL, SPIRVKind.OP_TYPE_INT_8);
  public static final SPIRVMemoryBase privateSpace =
      new SPIRVMemoryBase(
          2, PRIVATE_REGION_NAME, SPIRVMemorySpace.PRIVATE, SPIRVKind.OP_TYPE_INT_8);
  ...
  public SPIRVArchitecture(SPIRVKind wordKind, ByteOrder byteOrder, SPIRVRuntimeType runtime) {
    super(
        BACKEND_ARCHITECTURE + "@" + runtime.name(),
        wordKind,
        byteOrder,
        false,
        null,
