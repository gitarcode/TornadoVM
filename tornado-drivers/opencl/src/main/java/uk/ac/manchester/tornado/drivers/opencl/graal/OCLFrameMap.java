 ...
 *
 * <p>This is the format of an AMD64 stack frame:
 *
 * <pre>
 *   Base       Contents
 *
 ...
 *
 * <p>A runtime can reserve space at the beginning of the overflow argument area. The calling
...
public class OCLFrameMap extends FrameMap {
  ...
  public OCLFrameMap(
      ...
      ReferenceMapBuilderFactory referenceMapFactory) {
  ...
  public StackSlot allocateDeoptimizationRescueSlot() {
    assert spillSize == initialSpillSize
            || spillSize == initialSpillSize + spillSlotSize(LIRKind.value(OCLKind.ULONG))
        : "Deoptimization rescue slot must be the first or second (if there is an RBP spill slot)"
              + " stack slot";
