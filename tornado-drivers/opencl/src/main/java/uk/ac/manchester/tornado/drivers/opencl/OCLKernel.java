...
public class OCLKernel {
  ...
  static native void clReleaseKernel(long kernelId) throws OCLException;

  static native void clSetKernelArg(long kernelId, int index, long size, byte[] buffer)
      throws OCLException;

  static native void clSetKernelArgRef(long kernelId, int index, long buffer) throws OCLException;

  static native void clGetKernelInfo(long kernelId, int info, byte[] buffer) throws OCLException;
  ...
  private void queryName() {
    ...
    try {
      clGetKernelInfo(
          oclKernelID, OCLKernelInfo.CL_KERNEL_FUNCTION_NAME.getValue(), buffer.array());
