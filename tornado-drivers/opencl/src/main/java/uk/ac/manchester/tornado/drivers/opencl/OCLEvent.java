...
public class OCLEvent implements Event {
  ...
  public OCLEvent(
      String eventNameDescription,
      final OCLCommandQueue queue,
      final int event,
      final long oclEventID) {
    this();
    this.queue = queue;
    this.localId = event;
  ...
  static native void clGetEventInfo(long eventId, int param, byte[] buffer) throws OCLException;

  static native void clGetEventProfilingInfo(long eventId, long param, byte[] buffer)
      throws OCLException;

  static native void clWaitForEvents(long[] events) throws OCLException;

  static native void clReleaseEvent(long eventId) throws OCLException;
