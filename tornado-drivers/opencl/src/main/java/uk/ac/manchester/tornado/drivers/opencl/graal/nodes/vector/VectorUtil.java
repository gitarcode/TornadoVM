...
public final class VectorUtil {
  ...
  private static final OCLBinaryIntrinsic[] loadTable =
      new OCLBinaryIntrinsic[] {VLOAD2, VLOAD3, VLOAD4, VLOAD8, VLOAD16};

  private static final OCLTernaryIntrinsic[] storeTable =
      new OCLTernaryIntrinsic[] {VSTORE2, VSTORE3, VSTORE4, VSTORE8, VSTORE16};

  private static final OCLUnaryOp[] pointerTable =
      new OCLUnaryOp[] {CAST_TO_SHORT_PTR, CAST_TO_INT_PTR, CAST_TO_FLOAT_PTR, CAST_TO_BYTE_PTR};

  private static final OCLOp2[] assignOp2Table =
      new OCLOp2[] {VMOV_SHORT2, VMOV_INT2, VMOV_FLOAT2, VMOV_BYTE2, VMOV_DOUBLE2, VMOV_HALF2};
  private static final OCLOp3[] assignOp3Table =
      new OCLOp3[] {VMOV_SHORT3, VMOV_INT3, VMOV_FLOAT3, VMOV_BYTE3, VMOV_DOUBLE3, VMOV_HALF3};
  private static final OCLOp4[] assignOp4Table =
      new OCLOp4[] {VMOV_SHORT4, VMOV_INT4, VMOV_FLOAT4, VMOV_BYTE4, VMOV_DOUBLE4, VMOV_HALF4};
  private static final OCLOp8[] assignOp8Table =
      new OCLOp8[] {VMOV_SHORT8, VMOV_INT8, VMOV_FLOAT8, VMOV_BYTE8, VMOV_DOUBLE8, VMOV_HALF8};
  private static final OCLOp16[] assignOp16Table =
      new OCLOp16[] {
        VMOV_SHORT16, VMOV_INT16, VMOV_FLOAT16, VMOV_BYTE16, VMOV_DOUBLE16, VMOV_HALF16
      };
  ...
  private static <T> T lookupValueByLength(T[] array, OCLKind vectorKind) {
    ...
    if (index != -1) {
      ...
      throw TornadoInternalError.shouldNotReachHere(
          "Unsupported vector type: " + vectorKind.toString());
    }
  }
