...
public final class OCLAssembler extends Assembler {
  ...
  /**
   * It converts the format of a Value input to a specific format based on its platform type.
   *
   * @param input The {@link Value} input to convert.
  ...
  public static String convertValueFromGraalFormat(Value input) {
    ...
    OCLVariablePrefix typePrefix =
        Arrays.stream(OCLVariablePrefix.values())
   ...
   *
   * @param value the {@link Value} object to extract the index from. It should be in the format
   *     "int[20|0x14]".
  ...
  private void emitAtomicIntrinsics() {
    // @formatter:off
    emitLine(
        "inline void atomicAdd_Tornado_Floats(volatile __global float *source, const float operand)"
            + " {\n"
            + "   union {\n"
            + "       unsigned int intVal;\n"
            + "       float floatVal;\n"
    ...
    emitLine(
        "inline void atomicAdd_Tornado_Floats2(volatile __global float *addr, float val)\n"
            + "{\n"
            + "    union {\n"
            + "        unsigned int u32;\n"
            + "        float f32;\n"
    ...
    emitLine(
        "inline void atomicMul_Tornado_Int(volatile __global int *source, const float operand) {\n"
            + "   union {\n"
            + "       unsigned int intVal;\n"
            + "       int value;\n"
            + "   } newVal;\n"
  ...
  /**
   * Used to emit function defs and control flow statements. i.e. strings that do not terminate with
   * a ';'
   *
   * @param fmt
   * @param args
  ...
  public String formatConstant(ConstantValue cv) {
    ...
    if (javaConstant.isNull()) {
      ...
      if (objConst.getJavaKind().isObject()
          && objConst.getType().getName().compareToIgnoreCase("Ljava/lang/String;") == 0) {
  ...
  public static class OCLUnaryIntrinsic extends OCLUnaryOp {
    ...
    public static final OCLUnaryIntrinsic OCL_KERNEL_CONTEXT_ACCESS =
        new OCLUnaryIntrinsic("_kernel_context");
    ...
    public static final OCLUnaryIntrinsic ATOMIC_FETCH_ADD_EXPLICIT =
        new OCLUnaryIntrinsic("atomic_fetch_add_explicit");
    public static final OCLUnaryIntrinsic ATOMIC_FETCH_SUB_EXPLICIT =
        new OCLUnaryIntrinsic("atomic_fetch_sub_explicit");
    public static final OCLUnaryIntrinsic ATOMIC_ADD = new OCLUnaryIntrinsic("atomic_add");
    public static final OCLUnaryIntrinsic ATOMIC_VAR_INIT =
        new OCLUnaryIntrinsic("ATOMIC_VAR_INIT");
    ...
    public static final OCLUnaryIntrinsic MEMORY_ORDER_RELAXED =
        new OCLUnaryIntrinsic("memory_order_relaxed");
    ...
    public static final OCLUnaryIntrinsic WRITE_MEM_FENCE =
        new OCLUnaryIntrinsic("write_mem_fence");
  ...
  public static class OCLUnaryTemplate extends OCLUnaryOp {
    ...
    public static final OCLUnaryTemplate MEM_CHECK =
        new OCLUnaryTemplate("mem check", "MEM_CHECK(%s)");
    public static final OCLUnaryTemplate INDIRECTION = new OCLUnaryTemplate("deref", "*(%s)");
    public static final OCLUnaryTemplate CAST_TO_POINTER =
        new OCLUnaryTemplate("cast ptr", "(%s *)");
    public static final OCLUnaryTemplate LOAD_ADDRESS_ABS =
        new OCLUnaryTemplate("load address", "*(%s)");
    ...
    public static final OCLUnaryTemplate NEW_LONG_ARRAY =
        new OCLUnaryTemplate("long[]", "long[%s]");
    public static final OCLUnaryTemplate NEW_FLOAT_ARRAY =
        new OCLUnaryTemplate("float[]", "float[%s]");
    public static final OCLUnaryTemplate NEW_DOUBLE_ARRAY =
        new OCLUnaryTemplate("double[]", "double[%s]");
    public static final OCLUnaryTemplate NEW_BYTE_ARRAY =
        new OCLUnaryTemplate("char[]", "char[%s]");
    public static final OCLUnaryTemplate NEW_CHAR_ARRAY =
        new OCLUnaryTemplate("char[]", "char[%s]");
    public static final OCLUnaryTemplate NEW_SHORT_ARRAY =
        new OCLUnaryTemplate("short[]", "short[%s]");
  ...
  public static class OCLBinaryIntrinsicCmp extends OCLBinaryOp {
    ...
    public static final OCLBinaryIntrinsicCmp FLOAT_IS_NOT_EQUAL =
        new OCLBinaryIntrinsicCmp("isnotequal");
    public static final OCLBinaryIntrinsicCmp FLOAT_IS_GREATER =
        new OCLBinaryIntrinsicCmp("isgreater");
    public static final OCLBinaryIntrinsicCmp FLOAT_IS_GREATEREQUAL =
        new OCLBinaryIntrinsicCmp("isgreaterequal");
    public static final OCLBinaryIntrinsicCmp FLOAT_IS_LESS = new OCLBinaryIntrinsicCmp("isless");
    public static final OCLBinaryIntrinsicCmp FLOAT_IS_LESSEQUAL =
        new OCLBinaryIntrinsicCmp("islessequal");
    public static final OCLBinaryIntrinsicCmp FLOAT_IS_LESSGREATER =
        new OCLBinaryIntrinsicCmp("islessgreater");
  ...
  public static class OCLBinaryTemplate extends OCLBinaryOp {
    ...
    public static final OCLBinaryTemplate DECLARE_BYTE_ARRAY =
        new OCLBinaryTemplate("DECLARE_ARRAY", "byte %s[%s]");
    public static final OCLBinaryTemplate DECLARE_CHAR_ARRAY =
        new OCLBinaryTemplate("DECLARE_ARRAY", "char %s[%s]");
    public static final OCLBinaryTemplate DECLARE_SHORT_ARRAY =
        new OCLBinaryTemplate("DECLARE_ARRAY", "short %s[%s]");
    public static final OCLBinaryTemplate DECLARE_INT_ARRAY =
        new OCLBinaryTemplate("DECLARE_ARRAY", "int %s[%s]");
    public static final OCLBinaryTemplate DECLARE_LONG_ARRAY =
        new OCLBinaryTemplate("DECLARE_ARRAY", "long %s[%s]");
    public static final OCLBinaryTemplate DECLARE_FLOAT_ARRAY =
        new OCLBinaryTemplate("DECLARE_ARRAY", "float %s[%s]");
    public static final OCLBinaryTemplate DECLARE_DOUBLE_ARRAY =
        new OCLBinaryTemplate("DECLARE_ARRAY", "double %s[%s]");
    public static final OCLBinaryTemplate ARRAY_INDEX = new OCLBinaryTemplate("index", "%s[%s]");

    public static final OCLBinaryTemplate NEW_PRIVATE_CHAR_ARRAY =
        new OCLBinaryTemplate("new private array char", "__private char %s[%s]");
    public static final OCLBinaryTemplate NEW_PRIVATE_FLOAT_ARRAY =
        new OCLBinaryTemplate("new private array float", "__private float %s[%s]");
    public static final OCLBinaryTemplate NEW_PRIVATE_INT_ARRAY =
        new OCLBinaryTemplate("new private array int", "__private int %s[%s]");
    public static final OCLBinaryTemplate NEW_PRIVATE_DOUBLE_ARRAY =
        new OCLBinaryTemplate("new private array double", "__private double %s[%s]");
    public static final OCLBinaryTemplate NEW_PRIVATE_LONG_ARRAY =
        new OCLBinaryTemplate("new private array long", "__private long %s[%s]");
    public static final OCLBinaryTemplate NEW_PRIVATE_SHORT_ARRAY =
        new OCLBinaryTemplate("new private array short", "__private short %s[%s]");
    public static final OCLBinaryTemplate NEW_PRIVATE_BYTE_ARRAY =
        new OCLBinaryTemplate("new private array byte", "__private byte %s[%s]");

    public static final OCLBinaryTemplate PRIVATE_INT_ARRAY_PTR =
        new OCLBinaryTemplate("private pointer array int", "__private int* %s = %s");
    public static final OCLBinaryTemplate PRIVATE_CHAR_ARRAY_PTR =
        new OCLBinaryTemplate("private pointer array char", "__private char* %s = %s");
    public static final OCLBinaryTemplate PRIVATE_FLOAT_ARRAY_PTR =
        new OCLBinaryTemplate("private pointer array float", "__private float* %s = %s");
    public static final OCLBinaryTemplate PRIVATE_DOUBLE_ARRAY_PTR =
        new OCLBinaryTemplate("private pointer array double", "__private double* %s = %s");
    public static final OCLBinaryTemplate PRIVATE_LONG_ARRAY_PTR =
        new OCLBinaryTemplate("private pointer array long", "__private long* %s = %s");
    public static final OCLBinaryTemplate PRIVATE_SHORT_ARRAY_PTR =
        new OCLBinaryTemplate("private pointer array short", "__private short* %s = %s");
    public static final OCLBinaryTemplate PRIVATE_BYTE_ARRAY_PTR =
        new OCLBinaryTemplate("private pointer array byte", "__private byte* %s = %s");

    public static final OCLBinaryTemplate PRIVATE_INT_ARRAY_PTR_COPY =
        new OCLBinaryTemplate(
            "private pointer copy array int", "__private int* %s = ((__private int *) %s)");
    public static final OCLBinaryTemplate PRIVATE_CHAR_ARRAY_PTR_COPY =
        new OCLBinaryTemplate(
            "private pointer copy array char", "__private char* %s = ((__private char *) %s)");
    public static final OCLBinaryTemplate PRIVATE_FLOAT_ARRAY_PTR_COPY =
        new OCLBinaryTemplate(
            "private pointer copy array float", "__private float* %s = ((__private float *) %s)");
    public static final OCLBinaryTemplate PRIVATE_DOUBLE_ARRAY_PTR_COPY =
        new OCLBinaryTemplate(
            "private pointer copy array double",
            "__private double* %s = ((__private double *) %s)");
    public static final OCLBinaryTemplate PRIVATE_LONG_ARRAY_PTR_COPY =
        new OCLBinaryTemplate(
            "private pointer copy array long", "__private long* %s = ((__private long *) %s)");
    public static final OCLBinaryTemplate PRIVATE_SHORT_ARRAY_PTR_COPY =
        new OCLBinaryTemplate(
            "private pointer copy array short", "__private short* %s = ((__private short *) %s)");
    public static final OCLBinaryTemplate PRIVATE_BYTE_ARRAY_PTR_COPY =
        new OCLBinaryTemplate(
            "private pointer copy array byte", "__private byte* %s = ((__private byte *) %s)");

    public static final OCLBinaryTemplate NEW_LOCAL_FLOAT_ARRAY =
        new OCLBinaryTemplate("local memory array float", "__local float %s[%s]");
    public static final OCLBinaryTemplate NEW_LOCAL_INT_ARRAY =
        new OCLBinaryTemplate("local memory array int", "__local int %s[%s]");
    public static final OCLBinaryTemplate NEW_LOCAL_DOUBLE_ARRAY =
        new OCLBinaryTemplate("local memory array double", "__local double %s[%s]");
    public static final OCLBinaryTemplate NEW_LOCAL_LONG_ARRAY =
        new OCLBinaryTemplate("local memory array long", "__local long %s[%s]");
    public static final OCLBinaryTemplate NEW_LOCAL_SHORT_ARRAY =
        new OCLBinaryTemplate("local memory array short", "__local short %s[%s]");
    public static final OCLBinaryTemplate NEW_LOCAL_CHAR_ARRAY =
        new OCLBinaryTemplate("local memory array char", "__local char %s[%s]");
    public static final OCLBinaryTemplate NEW_LOCAL_BYTE_ARRAY =
        new OCLBinaryTemplate("local memory array byte", "__local byte %s[%s]");
    // @formatter:on
    private final String template;
  ...
  public static class OCLTernaryTemplate extends OCLTernaryOp {
    ...
    public static final OCLTernaryTemplate SELECT =
        new OCLTernaryTemplate("select", "(%s) ? %s : %s");
  ...
  public static class OCLOp8 extends OCLOp4 {
    ...
    public void emit(
        OCLCompilationResultBuilder crb,
        Value s0,
        Value s1,
        Value s2,
        Value s3,
