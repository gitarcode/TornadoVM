...
public class OCLGraphBuilderPlugins {
  ...
  private static void registerTornadoVMAtomicsPlugins(Registration r) {
    r.register(
        new InvocationPlugin("atomic_add", int[].class, Integer.TYPE, Integer.TYPE) {
          @Override
  ...
  private static void registerAtomicCall(Registration r, JavaKind returnedJavaKind) {
    r.register(
        new InvocationPlugin("incrementAndGet", Receiver.class) {
          @Override
          public boolean apply(
    ...
    r.register(
        new InvocationPlugin("decrementAndGet", Receiver.class) {
          @Override
          public boolean apply(
              GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver) {
    ...
    r.register(
        new InvocationPlugin("get", Receiver.class) {
          @Override
          public boolean apply(
              GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver) {
            ...
            if (isMethodFromAtomicClass(method) && method.getName().equals("<init>")) {
              ...
              if (atomic != null && args.length > 1) {
                ...
                if (initialValue instanceof ConstantNode) {
                  int value =
                      Integer.parseInt(((ConstantNode) initialValue).getValue().toValueString());
                  if (value == 0) {
  ...
  private static void registerLocalBarrier(Registration r) {
    r.register(
        new InvocationPlugin("localBarrier", Receiver.class) {
          @Override
          public boolean apply(
              GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver) {
            OCLBarrierNode localBarrierNode =
                new OCLBarrierNode(OCLBarrierNode.OCLMemFenceFlags.LOCAL);
  ...
  private static void registerGlobalBarrier(Registration r) {
    r.register(
        new InvocationPlugin("globalBarrier", Receiver.class) {
          @Override
          public boolean apply(
              GraphBuilderContext b, ResolvedJavaMethod targetMethod, Receiver receiver) {
            OCLBarrierNode localBarrierNode =
                new OCLBarrierNode(OCLBarrierNode.OCLMemFenceFlags.GLOBAL);
            b.add(localBarrierNode);
            return true;
          }
        });
  ...
  private static void registerIntLocalArray(
      Registration r, JavaKind returnedJavaKind, JavaKind elementType) {
    r.register(
        new InvocationPlugin("allocateIntLocalArray", Receiver.class, int.class) {
          @Override
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
            ...
            LocalArrayNode localArrayNode =
                new LocalArrayNode(OCLArchitecture.localSpace, elementType, constantNode);
  ...
  private static void registerLongLocalArray(
      Registration r, JavaKind returnedJavaKind, JavaKind elementType) {
    r.register(
        new InvocationPlugin("allocateLongLocalArray", Receiver.class, int.class) {
          @Override
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
  ...
  private static void registerFloatLocalArray(
      Registration r, JavaKind returnedJavaKind, JavaKind elementType) {
    r.register(
        new InvocationPlugin("allocateFloatLocalArray", Receiver.class, int.class) {
          @Override
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
  ...
  private static void registerDoubleLocalArray(
      Registration r, JavaKind returnedJavaKind, JavaKind elementType) {
    r.register(
        new InvocationPlugin("allocateDoubleLocalArray", Receiver.class, int.class) {
          @Override
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
      ...
      if (kind != JavaKind.Object && kind != JavaKind.Void && kind != JavaKind.Illegal) {
        r.register(
            new InvocationPlugin(
                "getAtIndex", Receiver.class, getValueLayoutClass(kind.toJavaClass()), long.class) {
              @Override
              public boolean apply(
                  GraphBuilderContext b,
                  ResolvedJavaMethod targetMethod,
  ...
  private static void registerTornadoVMIntrinsicsPlugins(InvocationPlugins plugins) {
    final InvocationPlugin printfPlugin =
        new InvocationPlugin("printf", String.class, Object[].class) {
    ...
    longReg.register(
        new InvocationPlugin("bitCount", Long.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Int,
                b.append(OCLIntUnaryIntrinsicNode.create(value, POPCOUNT, JavaKind.Long)));
            return true;
          }
        });
    ...
    intReg.register(
        new InvocationPlugin("bitCount", Integer.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Int,
                b.append(OCLIntUnaryIntrinsicNode.create(value, POPCOUNT, JavaKind.Int)));
            return true;
          }
        });
  }
    ...
    r.register(
        new InvocationPlugin("pow", Double.TYPE, Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(OCLFPBinaryIntrinsicNode.create(x, y, POW, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("sin", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(OCLFPUnaryIntrinsicNode.create(value, SIN, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("cos", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(OCLFPUnaryIntrinsicNode.create(value, COS, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("tan", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(OCLFPUnaryIntrinsicNode.create(value, TAN, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("tanh", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(OCLFPUnaryIntrinsicNode.create(value, TANH, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("atan", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(OCLFPUnaryIntrinsicNode.create(value, ATAN, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("atan2", Double.TYPE, Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(OCLFPBinaryIntrinsicNode.create(x, y, ATAN2, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("asin", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(OCLFPUnaryIntrinsicNode.create(x, ASIN, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("acos", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(OCLFPUnaryIntrinsicNode.create(x, ACOS, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("log", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(OCLFPUnaryIntrinsicNode.create(value, LOG, JavaKind.Double)));
            return true;
          }
        });
    ...
    r.register(
        new InvocationPlugin("exp", Double.TYPE) {
          ...
          public boolean apply(
            ...
            b.push(
                JavaKind.Double,
                b.append(OCLFPUnaryIntrinsicNode.create(value, EXP, JavaKind.Double)));
            return true;
          }
        });
  }
