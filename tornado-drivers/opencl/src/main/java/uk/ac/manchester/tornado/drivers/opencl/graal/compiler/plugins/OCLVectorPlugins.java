...
public final class OCLVectorPlugins {
  ...
  public static void registerPlugins(final Plugins ps, final InvocationPlugins plugins) {
    ...
    registerVectorCollectionsPlugins(
        plugins, OCLKind.VECTORFLOAT16, FloatArray.class, Float16.class);
    ...
    registerVectorCollectionsPlugins(
        plugins, OCLKind.VECTORDOUBLE2, DoubleArray.class, Double2.class);
    registerVectorCollectionsPlugins(
        plugins, OCLKind.VECTORDOUBLE3, DoubleArray.class, Double3.class);
    registerVectorCollectionsPlugins(
        plugins, OCLKind.VECTORDOUBLE4, DoubleArray.class, Double4.class);
    registerVectorCollectionsPlugins(
        plugins, OCLKind.VECTORDOUBLE8, DoubleArray.class, Double8.class);
    registerVectorCollectionsPlugins(
        plugins, OCLKind.VECTORDOUBLE16, DoubleArray.class, Double16.class);

    registerVectorCollectionsPlugins(
        plugins, OCLKind.VECTORHALF2, HalfFloatArray.class, Half2.class);
    registerVectorCollectionsPlugins(
        plugins, OCLKind.VECTORHALF3, HalfFloatArray.class, Half3.class);
    registerVectorCollectionsPlugins(
        plugins, OCLKind.VECTORHALF4, HalfFloatArray.class, Half4.class);
    registerVectorCollectionsPlugins(
        plugins, OCLKind.VECTORHALF8, HalfFloatArray.class, Half8.class);
    registerVectorCollectionsPlugins(
        plugins, OCLKind.VECTORHALF16, HalfFloatArray.class, Half16.class);

    registerVectorCollectionsPlugins(
        plugins, OCLKind.MATRIX2DFLOAT4, FloatArray.class, Float4.class);
    registerVectorCollectionsPlugins(
        plugins, OCLKind.MATRIX3DFLOAT4, FloatArray.class, Float4.class);
    registerVectorCollectionsPlugins(
        plugins, OCLKind.MATRIX4X4FLOAT, FloatArray.class, Float4.class);
  ...
  private static void registerVectorPlugins(
    ...
    r.register(
        new InvocationPlugin("mult", declaringClass, declaringClass) {
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
              Receiver receiver,
  ...
  private static void registerGeometricBIFS(
      final InvocationPlugins plugins, final OCLKind vectorKind) {
    final Class<?> declaringClass = vectorKind.getJavaClass();
    final Registration r = new Registration(plugins, declaringClass);
    r.register(
        new InvocationPlugin("dot", declaringClass, declaringClass) {
          public boolean apply(
              GraphBuilderContext b,
              ResolvedJavaMethod targetMethod,
              Receiver receiver,
          ...
          if (stampPair.getTrustedStamp() instanceof ObjectStamp) {
            ...
            if (objStamp.type().getAnnotation(Vector.class) != null) {
              ...
              return new ParameterNode(
                  index, StampPair.createSingle(OCLStampFactory.getStampFor(kind)));
            }
          }
          return null;
        });
