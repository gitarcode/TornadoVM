...
public class OCLProgram {
  ...
  static native void clBuildProgram(long programId, long[] devices, String options)
      throws OCLException;

  static native void clGetProgramInfo(long programId, int param, byte[] buffer) throws OCLException;

  static native void clGetProgramBuildInfo(long programId, long deviceId, int param, byte[] buffer)
      throws OCLException;

  static native long clCreateKernel(long programId, String name) throws OCLException;

  static native void getBinaries(long programId, long numDevices, ByteBuffer buffer)
      throws OCLException;
  ...
  public OCLBuildStatus getStatus(long deviceId) {
    ...
    try {
      clGetProgramBuildInfo(
          programPointer, deviceId, CL_PROGRAM_BUILD_STATUS.getValue(), buffer.array());
  ...
  public String getBuildLog(long deviceId) {
    ...
    try {
      clGetProgramBuildInfo(
          programPointer, deviceId, CL_PROGRAM_BUILD_LOG.getValue(), buffer.array());
