...
public class OCLFPGAScheduler extends OCLKernelScheduler {
  ...
  public static final String WARNING_FPGA_DEFAULT_LOCAL =
      "[TornadoVM OCL] Warning: TornadoVM uses as default local work group size for FPGAs: "
          + Arrays.toString(DEFAULT_LOCAL_WORK_SIZE)
          + ".";
