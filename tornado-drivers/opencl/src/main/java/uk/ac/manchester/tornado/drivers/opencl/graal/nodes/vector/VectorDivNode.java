...
public class VectorDivNode extends FloatingNode implements LIRLowerable, VectorOp {
  ...
  protected VectorDivNode(
      NodeClass<? extends VectorDivNode> c, OCLKind kind, ValueNode x, ValueNode y) {
    ...
    gen.getLIRGeneratorTool()
        .append(
            new AssignStmt(
                result,
                new OCLBinary.Expr(
                    OCLBinaryOp.DIV, gen.getLIRGeneratorTool().getLIRKind(stamp), input1, input2)));
