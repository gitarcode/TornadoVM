...
public class OCLLIRStmt {
  ...
  public static class MarkRelocateInstruction extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<MarkRelocateInstruction> TYPE =
        LIRInstructionClass.create(MarkRelocateInstruction.class);
  ...
  public static class MoveStmt extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<MoveStmt> TYPE =
        LIRInstructionClass.create(MoveStmt.class);
  ...
  public static class LoadStmt extends AbstractInstruction {
    ...
    private boolean isLocalOrPrivateLoad() {
      return this.cast.getMemorySpace().getBase().getMemorySpace() == OCLMemorySpace.LOCAL
          || this.cast.getMemorySpace().getBase().getMemorySpace() == OCLMemorySpace.PRIVATE;
    }
  ...
  public static class StoreStmt extends AbstractInstruction {
    ...
    /**
     * It emits code in the form: <code>
     * ul_12[index] = value;
     * </code>
     *
     * @param crb OpenCL Compilation Result Builder
     * @param asm OpenCL Assembler
     */
  ...
  public static class VectorStoreStmt extends AbstractInstruction {
    ...
    public VectorStoreStmt(
        OCLTernaryIntrinsic op, Value index, OCLAddressCast cast, MemoryAccess address, Value rhs) {
      super(TYPE);
      this.rhs = rhs;
      this.cast = cast;
      this.address = address;
  ...
  public static class RelocatedExpressionStmt extends ExprStmt {
    ...
    public static final LIRInstructionClass<RelocatedExpressionStmt> TYPE =
        LIRInstructionClass.create(RelocatedExpressionStmt.class);
  ...
  public static class PragmaExpr extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<PragmaExpr> TYPE =
        LIRInstructionClass.create(PragmaExpr.class);

    @Use protected Value prg;
