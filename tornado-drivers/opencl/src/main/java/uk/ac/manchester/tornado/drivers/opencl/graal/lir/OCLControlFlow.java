...
public class OCLControlFlow {
  ...
  protected abstract static class AbstractBlockEndOp extends AbstractInstruction
  ...
  public static final class ReturnOp extends AbstractBlockEndOp {
    ...
    public static final LIRInstructionClass<ReturnOp> TYPE =
        LIRInstructionClass.create(ReturnOp.class);
    @Use private Value x;
  ...
  public static final class EndScopeOp extends AbstractBlockEndOp {
    ...
    public static final LIRInstructionClass<EndScopeOp> TYPE =
        LIRInstructionClass.create(EndScopeOp.class);
  ...
  public static final class BeginScopeOp extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<BeginScopeOp> TYPE =
        LIRInstructionClass.create(BeginScopeOp.class);
  ...
  public static class LoopInitOp extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<LoopInitOp> TYPE =
        LIRInstructionClass.create(LoopInitOp.class);
  ...
  public static class LoopPostOp extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<LoopPostOp> TYPE =
        LIRInstructionClass.create(LoopPostOp.class);
   ...
   * {@link org.graalvm.compiler.lir.LIRInstruction}s between the loop condition and the {@link
   * LoopPostOp}, respectively the {@link LoopInitOp}.
   */
  public static class LoopConditionOp extends AbstractInstruction {

    public static final LIRInstructionClass<LoopConditionOp> TYPE =
        LIRInstructionClass.create(LoopConditionOp.class);
  ...
  public static class ConditionalBranchOp extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<ConditionalBranchOp> TYPE =
        LIRInstructionClass.create(ConditionalBranchOp.class);
    @Use private final Value condition;
  ...
  public static class LinkedConditionalBranchOp extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<LinkedConditionalBranchOp> TYPE =
        LIRInstructionClass.create(LinkedConditionalBranchOp.class);
    @Use private final Value condition;
  ...
  public static class ElseBranchOp extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<ElseBranchOp> TYPE =
        LIRInstructionClass.create(ElseBranchOp.class);
  ...
  public static class SwitchOp extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<SwitchOp> TYPE =
        LIRInstructionClass.create(SwitchOp.class);

    @Use private final AllocatableValue value;
  ...
  public static class DefaultCaseOp extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<DefaultCaseOp> TYPE =
        LIRInstructionClass.create(DefaultCaseOp.class);
  ...
  public static class CaseBreakOp extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<CaseBreakOp> TYPE =
        LIRInstructionClass.create(CaseBreakOp.class);
  ...
  public static class LoopBreakOp extends AbstractInstruction {
    ...
    public static final LIRInstructionClass<LoopBreakOp> TYPE =
        LIRInstructionClass.create(LoopBreakOp.class);
