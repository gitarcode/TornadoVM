...
/**
 * Compiler phase to set the position in the Panama Object header in which the Array Size will be
 * located. By default, we set the size in position 0 of the input array. The array header size is
 * determined by the TornadoVM API.
 */
