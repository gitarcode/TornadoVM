 ...
 *
 * <p>Task-based parallel API to express methods to be accelerated on any OpenCL, PTX and/or SPIR-V
 * compatible device.
 *
 * @since v0.15
 */
public class TaskGraph implements TaskGraphInterface {
  ...
  private static final String ERROR_TASK_NAME_DUPLICATION = //
      "[TornadoVM ERROR]. There are more than 1 tasks with the same task-name. Use different a"
          + " different task name for each task within a TaskGraph.";
   ...
   *
   * @param taskPackage {@link uk.ac.manchester.tornado.api.common.TaskPackage}
   ...
   *
   * @param id Task-id
   * @param code Reference to an existing Java method with one argument
   * @return {@link TaskGraph}
   */
  @Override
   ...
   * @param id Task-id
   * @param code Reference to an existing Java method with one argument
   * @param arg Argument to the method
   * @return {@link TaskGraph}
   */
  @Override
   ...
   *
   * @param id Task-id
   * @param code Reference to an existing Java method with two arguments
   * @param arg1 Argument 1 to the method
   * @param arg2 Argument 2 to the method
   * @return {@link TaskGraph}
   */
  @Override
   ...
   *
   * @param id Task-id
   * @param code Reference to an existing Java method with three arguments
   * @param arg1 Argument 1 to the method
   * @param arg2 Argument 2 to the method
   * @param arg3 Argument 3 to the method
   * @return {@link TaskGraph}
   */
  @Override
   ...
   *
   * @param id Task-id
   * @param code Reference to an existing Java method with four arguments
   * @param arg1 Argument 1 to the method
   * @param arg2 Argument 2 to the method
   * @param arg3 Argument 3 to the method
   * @param arg4 Argument 4 to the method
   * @return {@link TaskGraph}
   */
  @Override
  public <T1, T2, T3, T4> TaskGraph task(
      String id, Task4<T1, T2, T3, T4> code, T1 arg1, T2 arg2, T3 arg3, T4 arg4) {
    checkTaskName(id);
   ...
   *
   * @param id Task-id
   * @param code Reference to an existing Java method with five arguments
   * @param arg1 Argument 1 to the method
   * @param arg2 Argument 2 to the method
   * @param arg3 Argument 3 to the method
   * @param arg4 Argument 4 to the method
   * @param arg5 Argument 5 to the method
   * @return {@link TaskGraph}
   */
  @Override
  public <T1, T2, T3, T4, T5> TaskGraph task(
      String id, Task5<T1, T2, T3, T4, T5> code, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5) {
    checkTaskName(id);
   ...
   *
   * @param id Task-id
   * @param code Reference to an existing Java method with six arguments
   * @param arg1 Argument 1 to the method
   * @param arg2 Argument 2 to the method
   * @param arg3 Argument 3 to the method
   * @param arg4 Argument 4 to the method
   * @param arg5 Argument 5 to the method
   * @param arg6 Argument 6 to the method
   * @return {@link TaskGraph}
   */
  @Override
  public <T1, T2, T3, T4, T5, T6> TaskGraph task(
      String id,
      Task6<T1, T2, T3, T4, T5, T6> code,
      T1 arg1,
      T2 arg2,
      T3 arg3,
      T4 arg4,
    ...
    TaskPackage taskPackage =
        TaskPackage.createPackage(id, code, arg1, arg2, arg3, arg4, arg5, arg6);
    taskGraphImpl.addTask(taskPackage);
    return this;
  }
   ...
   *
   * @param id Task-id
   * @param code Reference to an existing Java method with seven arguments
   * @param arg1 Argument 1 to the method
   * @param arg2 Argument 2 to the method
   * @param arg3 Argument 3 to the method
   * @param arg4 Argument 4 to the method
   * @param arg5 Argument 5 to the method
   * @param arg6 Argument 6 to the method
   * @param arg7 Argument 7 to the method
   * @return {@link TaskGraph}
   */
  @Override
  public <T1, T2, T3, T4, T5, T6, T7> TaskGraph task(
      String id,
      Task7<T1, T2, T3, T4, T5, T6, T7> code,
      T1 arg1,
      T2 arg2,
      T3 arg3,
      T4 arg4,
    ...
    checkTaskName(id);
    TaskPackage taskPackage =
        TaskPackage.createPackage(id, code, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    taskGraphImpl.addTask(taskPackage);
    return this;
  }
   ...
   *
   * @param id Task-id
   * @param code Reference to an existing Java method with eight arguments
   * @param arg1 Argument 1 to the method
   * @param arg2 Argument 2 to the method
   * @param arg3 Argument 3 to the method
   * @param arg4 Argument 4 to the method
   ...
   * @param arg6 Argument 6 to the method
   * @param arg7 Argument 7 to the method
   * @param arg8 Argument 8 to the method
   * @return {@link TaskGraph}
   */
  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8> TaskGraph task(
      String id,
      Task8<T1, T2, T3, T4, T5, T6, T7, T8> code,
      T1 arg1,
      T2 arg2,
      T3 arg3,
      T4 arg4,
    ...
    checkTaskName(id);
    TaskPackage taskPackage =
        TaskPackage.createPackage(id, code, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    taskGraphImpl.addTask(taskPackage);
    return this;
  }
   ...
   *
   * @param id Task-id
   * @param code Reference to an existing Java method with nine arguments
   * @param arg1 Argument 1 to the method
   * @param arg2 Argument 2 to the method
   * @param arg3 Argument 3 to the method
   * @param arg4 Argument 4 to the method
   ...
   * @param arg7 Argument 7 to the method
   * @param arg8 Argument 8 to the method
   * @param arg9 Argument 9 to the method
   * @return {@link TaskGraph}
   */
  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8, T9> TaskGraph task(
      String id,
      Task9<T1, T2, T3, T4, T5, T6, T7, T8, T9> code,
      T1 arg1,
      T2 arg2,
      T3 arg3,
      T4 arg4,
    ...
    checkTaskName(id);
    TaskPackage taskPackage =
        TaskPackage.createPackage(id, code, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
    taskGraphImpl.addTask(taskPackage);
    return this;
  }
   ...
   *
   * @param id Task-id
   * @param code Reference to an existing Java method with 10 arguments
   * @param arg1 Argument 1 to the method
   * @param arg2 Argument 2 to the method
   * @param arg3 Argument 3 to the method
   * @param arg4 Argument 4 to the method
   ...
   * @param arg8 Argument 8 to the method
   * @param arg9 Argument 9 to the method
   * @param arg10 Argument 10 to the method
   * @return {@link TaskGraph}
   */
  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> TaskGraph task(
      String id,
      Task10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> code,
      T1 arg1,
      T2 arg2,
      T3 arg3,
      T4 arg4,
    ...
    checkTaskName(id);
    TaskPackage taskPackage =
        TaskPackage.createPackage(
            id, code, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
    taskGraphImpl.addTask(taskPackage);
    return this;
  }
   ...
   * @param arg9 Argument 9 to the method
   * @param arg10 Argument 10 to the method
   * @param arg11 Argument 11 to the method
   * @return {@link TaskGraph}
   */
  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> TaskGraph task(
      String id,
      Task11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> code,
      T1 arg1,
      T2 arg2,
      T3 arg3,
      T4 arg4,
    ...
    TaskPackage taskPackage =
        TaskPackage.createPackage(
            id, code, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
    taskGraphImpl.addTask(taskPackage);
    return this;
  }
   ...
   * @param arg10 Argument 10 to the method
   * @param arg11 Argument 11 to the method
   * @param arg12 Argument 12 to the method
   * @return {@link TaskGraph}
   */
  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> TaskGraph task(
      String id,
      Task12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> code,
      T1 arg1,
      T2 arg2,
      T3 arg3,
      T4 arg4,
    ...
    TaskPackage taskPackage =
        TaskPackage.createPackage(
            id, code, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12);
    taskGraphImpl.addTask(taskPackage);
    return this;
  }
   ...
   * @param arg11 Argument 11 to the method
   * @param arg12 Argument 12 to the method
   * @param arg13 Argument 13 to the method
   * @return {@link TaskGraph}
   */
  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> TaskGraph task(
      String id,
      Task13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> code,
      T1 arg1,
      T2 arg2,
      T3 arg3,
      T4 arg4,
   ...
   * @param arg12 Argument 12 to the method
   * @param arg13 Argument 13 to the method
   * @param arg14 Argument 14 to the method
   * @return {@link TaskGraph}
   */
  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> TaskGraph task(
      String id,
      Task14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> code,
      T1 arg1,
      T2 arg2,
      T3 arg3,
      T4 arg4,
   ...
   *
   * @param id Task-id
   * @param code Reference to an existing Java method with 15 arguments
   * @param arg1 Argument 1 to the method
   * @param arg2 Argument 2 to the method
   * @param arg3 Argument 3 to the method
   * @param arg4 Argument 4 to the method
   ...
   * @param arg13 Argument 13 to the method
   * @param arg14 Argument 14 to the method
   * @param arg15 Argument 15 to the method
   * @return {@link TaskGraph}
   */
  @Override
  public <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> TaskGraph task(
      String id,
      Task15<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> code,
      T1 arg1,
      T2 arg2,
      T3 arg3,
      T4 arg4,
  ...
  /**
   * @param id String that represents the task-id.
   * @param entryPoint Name of the kernel to be launched on the target device.
   * @param filename String that represents the path to the native source (e.g., the OpenCL C
   *     kernel).
   * @param accessorParameters {@link AccessorParameters} with the type of accessor for each of the
   *     input parameters to the low-level kernel.
   * @return {@link TaskGraph}
   */
  @Override
  public TaskGraph prebuiltTask(
      String id, String entryPoint, String filename, AccessorParameters accessorParameters) {
    checkTaskName(id);
    TaskPackage prebuiltTask =
        TaskPackage.createPrebuiltTask(id, entryPoint, filename, accessorParameters);
   ...
   *
   * @param id Task-id
   * @param entryPoint Kernel's name of the entry point
   * @param filename Input OpenCL C Kernel
   * @param accessorParameters {@link AccessorParameters} with the type of accessor for each of the
   *     input parameters to the low-level kernel.
   * @param atomics Atomics region.
   * @return {@link TaskGraph}
   */
  @Override
  public TaskGraph prebuiltTask(
      ...
      int[] atomics) {
    checkTaskName(id);
    PrebuiltTaskPackage prebuiltTask =
        TaskPackage.createPrebuiltTask(id, entryPoint, filename, accessorParameters);
   ...
   *
   * <p>{@link uk.ac.manchester.tornado.api.enums.DataTransferMode#FIRST_EXECUTION}: it transfers
   * data only the first execution of the task-graph (READ ONLY) {@link
   * uk.ac.manchester.tornado.api.enums.DataTransferMode#EVERY_EXECUTION}: it transfers data for
   * every execution of the task-graph (READ/WRITE)
   *
   * @param mode A mode from {@link uk.ac.manchester.tornado.api.enums.DataTransferMode}
   * @param objects List of Java objects (usually arrays) to be transferred to the device.
   * @return {@link TaskGraph}
   */
  @Override
  ...
  /**
   * Tag a set of objects (Java objects) to be transferred from the device to the host after the
   * execution completes. There are two modes:
   *
   * <p>{@link uk.ac.manchester.tornado.api.enums.DataTransferMode#EVERY_EXECUTION}: transfers data
   * for every execution of the task-graph (WRITE only) {@link
   * uk.ac.manchester.tornado.api.enums.DataTransferMode#UNDER_DEMAND}: it transfers data only under
   * demand. Data are not transferred unless the execution-plan, an {@link TornadoExecutionPlan}
   * object, invokes the `transferToHost` function. This is used for optimization of data transfers.
   *
   * @param mode A mode from {@link uk.ac.manchester.tornado.api.enums.DataTransferMode}
   * @param objects List of Java objects (usually arrays) to be transferred to the device.
   * @return {@link TaskGraph}
  ...
  /**
   * Function that closes a task-graph definition and creates an immutable task-graph ready for
   * execution.
   *
