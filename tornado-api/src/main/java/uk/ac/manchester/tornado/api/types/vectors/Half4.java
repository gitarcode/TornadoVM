...
public final class Half4 implements TornadoVectorsInterface<ShortBuffer> {
  ...
  /** backing array. */
  @Payload short[] storage = new short[4];
  ...
  public static Half4 add(Half4 a, Half4 b) {
    return new Half4(
        HalfFloat.add(a.getX(), b.getX()),
        HalfFloat.add(a.getY(), b.getY()),
        HalfFloat.add(a.getZ(), b.getZ()),
        HalfFloat.add(a.getW(), b.getW()));
  }

  public static Half4 sub(Half4 a, Half4 b) {
    return new Half4(
        HalfFloat.sub(a.getX(), b.getX()),
        HalfFloat.sub(a.getY(), b.getY()),
        HalfFloat.sub(a.getZ(), b.getZ()),
        HalfFloat.sub(a.getW(), b.getW()));
  }

  public static Half4 div(Half4 a, Half4 b) {
    return new Half4(
        HalfFloat.div(a.getX(), b.getX()),
        HalfFloat.div(a.getY(), b.getY()),
        HalfFloat.div(a.getZ(), b.getZ()),
        HalfFloat.div(a.getW(), b.getW()));
  }

  public static Half4 mult(Half4 a, Half4 b) {
    return new Half4(
        HalfFloat.mult(a.getX(), b.getX()),
        HalfFloat.mult(a.getY(), b.getY()),
        HalfFloat.mult(a.getZ(), b.getZ()),
        HalfFloat.mult(a.getW(), b.getW()));
  }

  public static Half4 add(Half4 a, HalfFloat b) {
    return new Half4(
        HalfFloat.add(a.getX(), b),
        HalfFloat.add(a.getY(), b),
        HalfFloat.add(a.getZ(), b),
        HalfFloat.add(a.getW(), b));
  }

  public static Half4 sub(Half4 a, HalfFloat b) {
    return new Half4(
        HalfFloat.sub(a.getX(), b),
        HalfFloat.sub(a.getY(), b),
        HalfFloat.sub(a.getZ(), b),
        HalfFloat.sub(a.getW(), b));
  }

  public static Half4 mult(Half4 a, HalfFloat b) {
    return new Half4(
        HalfFloat.mult(a.getX(), b),
        HalfFloat.mult(a.getY(), b),
        HalfFloat.mult(a.getZ(), b),
        HalfFloat.mult(a.getW(), b));
  }

  public static Half4 div(Half4 a, HalfFloat b) {
    return new Half4(
        HalfFloat.div(a.getX(), b),
        HalfFloat.div(a.getY(), b),
        HalfFloat.div(a.getZ(), b),
        HalfFloat.div(a.getW(), b));
  }
