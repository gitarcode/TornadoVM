...
public final class Half16 implements TornadoVectorsInterface<ShortBuffer> {
  ...
  /** backing array. */
  @Payload short[] storage = new short[NUM_ELEMENTS];
  ...
  public static HalfFloat dot(Half16 a, Half16 b) {
    ...
    return HalfFloat.add(
        HalfFloat.add(
            HalfFloat.add(HalfFloat.add(m.getS0(), m.getS1()), HalfFloat.add(m.getS2(), m.getS3())),
            HalfFloat.add(
                HalfFloat.add(m.getS4(), m.getS5()), HalfFloat.add(m.getS6(), m.getS7()))),
        HalfFloat.add(
            HalfFloat.add(
                HalfFloat.add(m.getS8(), m.getS9()), HalfFloat.add(m.getS10(), m.getS11())),
            HalfFloat.add(
                HalfFloat.add(m.getS12(), m.getS13()), HalfFloat.add(m.getS14(), m.getS15()))));
  }
  ...
  public String toString(String fmt) {
    return String.format(
        fmt, getS0(), getS1(), getS2(), getS3(), getS4(), getS5(), getS6(), getS7(), getS8(),
        getS9(), getS10(), getS11(), getS12(), getS13(), getS13(), getS14(), getS15());
  }
