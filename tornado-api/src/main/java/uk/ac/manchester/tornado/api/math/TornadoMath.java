...
public class TornadoMath {
  ...
  /**
   * In PTX, the exp operation that accepts a double input is narrowed to f32, since the PTX
   * instruction does not support f64 operands.
   */
  ...
  public static Float4 cos(Float4 f) {
    return new Float4(
        TornadoMath.cos(f.getX()),
        TornadoMath.cos(f.getY()),
        TornadoMath.cos(f.getZ()),
        TornadoMath.cos(f.getW()));
  }
  ...
  public static Float4 sin(Float4 f) {
    return new Float4(
        TornadoMath.sin(f.getX()),
        TornadoMath.sin(f.getY()),
        TornadoMath.sin(f.getZ()),
        TornadoMath.sin(f.getW()));
  }
  ...
  /**
   * In PTX, the log operation that accepts a double input is narrowed to f32, since the PTX
   * instruction does not support f64 operands.
   */
  ...
  /**
   * In PTX, the log2 operation that accepts a double input is narrowed to f32, since the PTX
   * instruction does not support f64 operands.
   */
  ...
  /**
   * In PTX, the cos operation that accepts a double input is narrowed to f32, since the PTX
   * instruction does not support f64 operands.
   */
  ...
  /**
   * In PTX, the sin operation that accepts a double input is narrowed to f32, since the PTX
   * instruction does not support f64 operands.
   */
  ...
  /**
   * In PTX, the sinpi operation that accepts a double input is narrowed to f32, since the PTX sin
   * instruction does not support f64 operands.
   */
  ...
  /**
   * In PTX, the cospi operation that accepts a double input is narrowed to f32, since the PTX cos
   * instruction does not support f64 operands.
   */
  ...
  public static Float3 rotate(Matrix4x4Float m, Float3 x) {
    return new Float3(
        dot(m.row(0).asFloat3(), x), dot(m.row(1).asFloat3(), x), dot(m.row(2).asFloat3(), x));
  }
