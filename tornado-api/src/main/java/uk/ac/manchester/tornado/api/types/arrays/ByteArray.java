...
/**
 * This class represents an array of bytes stored in native memory. The byte data is stored in a
 * {@link MemorySegment}, which represents a contiguous region of off-heap memory. The class also
 * encapsulates methods for setting and getting byte values, for initializing the byte array, and
...
public final class ByteArray extends TornadoNativeArray {
  ...
  /**
   * Constructs a new instance of the {@link ByteArray} that will store a user-specified number of
   * elements.
   *
  ...
  /**
   * Constructs a new {@link ByteArray} instance by concatenating the contents of the given array of
   * {@link ByteArray} instances.
   *
   * @param arrays An array of {@link ByteArray} instances to be concatenated into the new instance.
   */
   ...
   *
   * @param buffer The {@link ByteBuffer} containing the float data.
   ...
   *
   * @return A new on-heap byte array, initialized with the values stored in the {@link ByteArray}
   *     instance.
   */
   ...
   *
   * @param value The byte value to initialize the {@link ByteArray} instance with.
   */
  ...
  /**
   * Returns the underlying {@link MemorySegment} of the {@link ByteArray} instance, including the
   * header.
   *
   * @return The {@link MemorySegment} associated with the {@link ByteArray} instance.
   */
   ...
   * ByteArray} instance, excluding the header bytes.
   *
   ...
   * @param value The float value to initialize the {@code ByteArray} instance with.
   */
   ...
   *
   * @param arrays Variable number of {@link ByteArray} objects to be concatenated.
  ...
  /**
   * Extracts a slice of elements from a given {@link ByteArray}, creating a new {@link ByteArray}
   * instance.
   *
   ...
   * @return A new {@link ByteArray} instance representing the specified slice of the original
   *     array.
