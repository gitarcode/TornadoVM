...
public final class VectorHalf implements TornadoCollectionInterface<ShortBuffer> {
   ...
   *
   * @param storage Array to be stored
   */
   ...
   *
   * @param index Position
   * @param value Half float value to be stored
   */
   ...
   *
   * @param values Set input array as internal stored
   */
   ...
   *
   * @param value Fill input array with value
   */
