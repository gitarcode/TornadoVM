...
public final class Half8 implements TornadoVectorsInterface<ShortBuffer> {
  ...
  /** backing array. */
  @Payload short[] storage = new short[8];
  ...
  public static HalfFloat dot(Half8 a, Half8 b) {
    ...
    return HalfFloat.add(
        ...
        HalfFloat.add(HalfFloat.add(m.getS4(), m.getS5()), HalfFloat.add(m.getS6(), m.getS7())));
  }
  ...
  public String toString(String fmt) {
    return String.format(
        fmt, getS0(), getS1(), getS2(), getS3(), getS4(), getS5(), getS6(), getS7());
  }
