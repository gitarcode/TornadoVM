...
public final class Double4 implements TornadoVectorsInterface<DoubleBuffer> {
  ...
  public static Double4 add(Double4 a, Double4 b) {
    return new Double4(
        a.getX() + b.getX(), a.getY() + b.getY(), a.getZ() + b.getZ(), a.getW() + b.getW());
  }
  ...
  public static Double4 sqrt(Double4 a) {
    return new Double4(
        TornadoMath.sqrt(a.getX()),
        TornadoMath.sqrt(a.getY()),
        TornadoMath.sqrt(a.getZ()),
        TornadoMath.sqrt(a.getW()));
  }

  public static Double4 floor(Double4 a) {
    return new Double4(
        TornadoMath.floor(a.getX()),
        TornadoMath.floor(a.getY()),
        TornadoMath.floor(a.getZ()),
        TornadoMath.floor(a.getW()));
  }

  public static Double4 fract(Double4 a) {
    return new Double4(
        TornadoMath.fract(a.getX()),
        TornadoMath.fract(a.getY()),
        TornadoMath.fract(a.getZ()),
        TornadoMath.fract(a.getW()));
  }
