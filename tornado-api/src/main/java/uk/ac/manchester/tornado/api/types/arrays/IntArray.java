...
/**
 * This class represents an array of ints stored in native memory. The int data is stored in a
 * {@link MemorySegment}, which represents a contiguous region of off-heap memory. The class also
 * encapsulates methods for setting and getting int values, for initializing the int array, and for
 * converting the array to and from different representations.
 */
...
public final class IntArray extends TornadoNativeArray {
  ...
  /**
   * Constructs a new instance of the {@link IntArray} that will store a user-specified number of
   * elements.
   *
  ...
  /**
   * Constructs a new {@link IntArray} instance by concatenating the contents of the given array of
   * {@link IntArray} instances.
   *
   * @param arrays An array of {@link IntArray} instances to be concatenated into the new instance.
   */
   ...
   *
   * @param buffer The {@link IntBuffer} containing the int data.
   ...
   *
   * @return A new on-heap int array, initialized with the values stored in the {@link IntArray}
   *     instance.
   */
   ...
   *
   * @param value The int value to initialize the {@link IntArray} instance with.
   */
   ...
   * IntArray} instance, excluding the header bytes.
   *
  ...
  /**
   * Returns the underlying {@link MemorySegment} of the {@link IntArray} instance, including the
   * header.
   *
   * @return The {@link MemorySegment} associated with the {@link IntArray} instance.
   */
   ...
   * @param value The float value to initialize the {@code IntArray} instance with.
   */
   ...
   *
   * @param arrays Variable number of {@link IntArray} objects to be concatenated.
  ...
  /**
   * Extracts a slice of elements from a given {@linkIntArray}, creating a new {@linkIntArray}
   * instance.
   *
