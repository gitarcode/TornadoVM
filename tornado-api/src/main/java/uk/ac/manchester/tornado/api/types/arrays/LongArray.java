...
/**
 * This class represents an array of longs stored in native memory. The long data is stored in a
 * {@link MemorySegment}, which represents a contiguous region of off-heap memory. The class also
 * encapsulates methods for setting and getting long values, for initializing the long array, and
...
public final class LongArray extends TornadoNativeArray {
  ...
  /**
   * Constructs a new instance of the {@link LongArray} that will store a user-specified number of
   * elements.
   *
  ...
  /**
   * Constructs a new {@link LongArray} instance by concatenating the contents of the given array of
   * {@link LongArray} instances.
   *
   * @param arrays An array of {@link LongArray} instances to be concatenated into the new instance.
   */
   ...
   *
   * @param buffer The {@link LongBuffer} containing the long data.
   ...
   *
   * @return A new on-heap long array, initialized with the values stored in the {@link LongArray}
   *     instance.
   */
   ...
   *
   * @param value The long value to initialize the {@link LongArray} instance with.
   */
  ...
  /**
   * Returns the underlying {@link MemorySegment} of the {@link LongArray} instance, including the
   * header.
   *
   * @return The {@link MemorySegment} associated with the {@link LongArray} instance.
   */
   ...
   * LongArray} instance, excluding the header bytes.
   *
   ...
   * @param value The float value to initialize the {@code LongArray} instance with.
   */
   ...
   *
   * @param arrays Variable number of {@link LongArray} objects to be concatenated.
  ...
  /**
   * Extracts a slice of elements from a given {@link LongArray}, creating a new {@link LongArray}
   * instance.
   *
   ...
   * @return A new {@link LongArray} instance representing the specified slice of the original
   *     array.
