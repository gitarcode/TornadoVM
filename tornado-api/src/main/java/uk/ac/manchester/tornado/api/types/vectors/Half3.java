...
public final class Half3 implements TornadoVectorsInterface<ShortBuffer> {
  ...
  /** backing array. */
  @Payload short[] storage = new short[3];
  ...
  public static Half3 add(Half3 a, HalfFloat b) {
    return new Half3(
        HalfFloat.add(a.getX(), b), HalfFloat.add(a.getY(), b), HalfFloat.add(a.getZ(), b));
  }

  public static Half3 sub(Half3 a, HalfFloat b) {
    return new Half3(
        HalfFloat.sub(a.getX(), b), HalfFloat.sub(a.getY(), b), HalfFloat.sub(a.getZ(), b));
  }

  public static Half3 mult(Half3 a, HalfFloat b) {
    return new Half3(
        HalfFloat.mult(a.getX(), b), HalfFloat.mult(a.getY(), b), HalfFloat.mult(a.getZ(), b));
  }

  public static Half3 div(Half3 a, HalfFloat b) {
    return new Half3(
        HalfFloat.div(a.getX(), b), HalfFloat.div(a.getY(), b), HalfFloat.div(a.getZ(), b));
  }
