...
/**
 * This class represents an array of characters stored in native memory. The char data is stored in
 * a {@link MemorySegment}, which represents a contiguous region of off-heap memory. The class also
 * encapsulates methods for setting and getting char values, for initializing the char array, and
...
public final class CharArray extends TornadoNativeArray {
  ...
  /**
   * Constructs a new instance of the {@link CharArray} that will store a user-specified number of
   * elements.
   *
  ...
  /**
   * Constructs a new {@link CharArray} instance by concatenating the contents of the given array of
   * {@link CharArray} instances.
   *
   * @param arrays An array of {@link CharArray} instances to be concatenated into the new instance.
   */
   ...
   *
   * @param buffer The {@link CharBuffer} containing the float data.
   ...
   *
   * @return A new on-heap char array, initialized with the values stored in the {@link CharArray}
   *     instance.
   */
   ...
   *
   * @param value The char value to initialize the {@link ByteArray} instance with.
   */
  ...
  /**
   * Returns the underlying {@link MemorySegment} of the {@link CharArray} instance, including the
   * header.
   *
   * @return The {@link MemorySegment} associated with the {@link CharArray} instance.
   */
   ...
   * CharArray} instance, excluding the header bytes.
   *
   ...
   * @param value The float value to initialize the {@code CharArray} instance with.
   */
   ...
   *
   * @param arrays Variable number of {@link CharArray} objects to be concatenated.
  ...
  /**
   * Extracts a slice of elements from a given {@link CharArray}, creating a new {@link CharArray}
   * instance.
   *
   ...
   * @return A new {@link CharArray} instance representing the specified slice of the original
   *     array.
