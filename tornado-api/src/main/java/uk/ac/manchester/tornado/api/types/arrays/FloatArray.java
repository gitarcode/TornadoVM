...
/**
 * This class represents an array of floats stored in native memory. The float data is stored in a
 * {@link MemorySegment}, which represents a contiguous region of off-heap memory. The class also
 * encapsulates methods for setting and getting float values, for initializing the float array, and
...
public final class FloatArray extends TornadoNativeArray {
  ...
  /**
   * Constructs a new instance of the {@link FloatArray} that will store a user-specified number of
   * elements.
   *
  ...
  /**
   * Constructs a new {@link FloatArray} instance by concatenating the contents of the given array
   * of {@link FloatArray} instances.
   *
   * @param arrays An array of {@link FloatArray} instances to be concatenated into the new
   *     instance.
   */
  ...
  public static FloatArray fromSegment(MemorySegment segment) {
    ...
    MemorySegment.copy(
        segment, 0, floatArray.segment, floatArray.baseIndex * FLOAT_BYTES, byteSize);
    return floatArray;
  }
   ...
   *
   * @return A new on-heap float array, initialized with the values stored in the {@link FloatArray}
   *     instance.
   */
  ...
  /**
   * Returns the underlying {@link MemorySegment} of the {@link FloatArray} instance, including the
   * header.
   *
   * @return The {@link MemorySegment} associated with the {@link FloatArray} instance.
   */
   ...
   * FloatArray} instance, excluding the header bytes.
   *
  ...
  /**
   * Factory method to initialize a {@link FloatArray}. This method can be invoked from a
   * Task-Graph.
   *
  ...
  /**
   * Extracts a slice of elements from a given {@link FloatArray}, creating a new {@link FloatArray}
   * instance.
   *
   ...
   * @return A new {@link FloatArray} instance representing the specified slice of the original
   *     array.
