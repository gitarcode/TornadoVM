...
public final class Double3 implements TornadoVectorsInterface<DoubleBuffer> {
  ...
  public static Double3 sqrt(Double3 a) {
    return new Double3(
        TornadoMath.sqrt(a.getX()), TornadoMath.sqrt(a.getY()), TornadoMath.sqrt(a.getZ()));
  }

  public static Double3 floor(Double3 a) {
    return new Double3(
        TornadoMath.floor(a.getX()), TornadoMath.floor(a.getY()), TornadoMath.floor(a.getZ()));
  }

  public static Double3 fract(Double3 a) {
    return new Double3(
        TornadoMath.fract(a.getX()), TornadoMath.fract(a.getY()), TornadoMath.fract(a.getZ()));
  }
