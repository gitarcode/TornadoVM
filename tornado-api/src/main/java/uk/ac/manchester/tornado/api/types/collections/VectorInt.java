...
public final class VectorInt implements TornadoCollectionInterface<IntBuffer> {
   ...
   *
   * @param storage vector int array
   */
   ...
   *
   * @param index index value
   * @param value value to be set in position index
   */
   ...
   *
   * @param values assign an input vector int to the internal array
   */
   ...
   *
   * @param value Fill input vector with value
   */
   ...
   *
   * @param vector Input vector to compare
