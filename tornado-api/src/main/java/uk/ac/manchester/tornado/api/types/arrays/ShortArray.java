...
/**
 * This class represents an array of shorts stored in native memory. The short data is stored in a
 * {@link MemorySegment}, which represents a contiguous region of off-heap memory. The class also
 * encapsulates methods for setting and getting short values, for initializing the short array, and
 * for converting the array to and from different representations.
 */
...
public final class ShortArray extends TornadoNativeArray {
  ...
  /**
   * Constructs a new instance of the {@link ShortArray} that will store a user-specified number of
   * elements.
   *
  ...
  /**
   * Constructs a new {@link ShortArray} instance by concatenating the contents of the given array
   * of {@link ShortArray} instances.
   *
   * @param arrays An array of {@link ShortArray} instances to be concatenated into the new
   *     instance.
   */
  ...
  public static ShortArray fromSegment(MemorySegment segment) {
    ...
    MemorySegment.copy(
        segment, 0, shortArray.segment, shortArray.baseIndex * SHORT_BYTES, byteSize);
    return shortArray;
  }
   ...
   *
   * @param buffer The {@link ShortBuffer} containing the short data.
   ...
   *
   * @return A new on-heap short array, initialized with the values stored in the {@link ShortArray}
   *     instance.
   */
   ...
   *
   * @param value The short value to initialize the {@link ShortArray} instance with.
   */
  ...
  /**
   * Returns the underlying {@link MemorySegment} of the {@link ShortArray} instance, including the
   * header.
   *
   * @return The {@link MemorySegment} associated with the {@link ShortArray} instance.
   */
   ...
   * ShortArray} instance, excluding the header bytes.
   *
  ...
  /**
   * Factory method to initialize a {@link ShortArray}. This method can be invoked from a
   * Task-Graph.
   *
   * @param array Input Array.
   * @param value The float value to initialize the {@code ShortArray} instance with.
   */
   ...
   *
   * @param arrays Variable number of {@link ShortArray} objects to be concatenated.
  ...
  /**
   * Extracts a slice of elements from a given {@link ShortArray}, creating a new {@link ShortArray}
   * instance.
   *
   ...
   * @return A new {@link ShortArray} instance representing the specified slice of the original
   *     array.
