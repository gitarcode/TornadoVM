...
/**
 * This class represents a float-16 instance (half float). The data is stored in a short field, to
 * be compliant with the representation for float-16 used in the {@link Float} class. The class
 * encapsulates methods for getting the data in float-16 and float-32 format, and for basic
...
public class HalfFloat {
  ...
  /**
   * Constructs a new instance of the {@code HalfFloat} out of a float value. To convert the float
   * to a float-16, the floatToFloat16 function of the {@link Float} class is used.
   *
   * @param halfFloat The float value that will be stored in a half-float format.
   */
   ...
   *
   * @param halfFloat The short value that represents the half float.
   */
   ...
   *
   * @param a The first float-16 input for the addition.
   * @param b The second float-16 input for the addition.
  ...
  /**
   * Takes two {@code HalfFloat} objects and returns a new {@HalfFloat} instance that contains the
   * results of the addition.
   *
   * @param a The first {@code HalfFloat} input for the addition.
   * @param b The second {@code HalfFloat} input for the addition.
  ...
  /**
   * Takes two half float values, converts them to a 32-bit representation and performs a
   * subtraction.
   *
   * @param a The first float-16 input for the subtraction.
   * @param b The second float-16 input for the subtraction.
   ...
   *
   * @param a The first {@code HalfFloat} input for the subtraction.
   * @param b The second {@code HalfFloat} input for the subtraction.
   ...
   * multiplication.
   *
   * @param a The first float-16 input for the multiplication.
   * @param b The second float-16 input for the multiplication.
   ...
   *
   * @param a The first {@code HalfFloat} input for the multiplication.
   * @param b The second {@code HalfFloat} input for the multiplication.
   ...
   *
   * @param a The first float-16 input for the division.
