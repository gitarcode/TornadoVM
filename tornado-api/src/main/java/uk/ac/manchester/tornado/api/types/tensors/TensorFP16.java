...
public final class TensorFP16 extends Tensor {
  ...
  public void init(HalfFloat value) {
    for (int i = 0; i < getSize(); i++) {
      tensorStorage
          ...
          .setAtIndex(JAVA_SHORT, getBaseIndex() + i, value.getHalfFloatValue());
    }
  }
  ...
  public void set(int index, HalfFloat value) {
    tensorStorage
        .getSegmentWithHeader()
        .setAtIndex(JAVA_SHORT, getBaseIndex() + index, value.getHalfFloatValue());
  }
  ...
  public HalfFloat get(int index) {
    short halfFloatValue =
        tensorStorage.getSegmentWithHeader().getAtIndex(JAVA_SHORT, getBaseIndex() + index);
   ...
   *
   * @param arrays Variable number of {@link TensorFP16} objects to be concatenated.
