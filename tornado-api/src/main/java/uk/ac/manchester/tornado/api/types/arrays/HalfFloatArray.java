...
/**
 * This class represents an array of half floats (float16 types) stored in native memory. The half
 * float data is stored in a {@link MemorySegment}, which represents a contiguous region of off-heap
 * memory. The class also encapsulates methods for setting and getting half float values, for
 * initializing the half float array, and for converting the array to and from different
 * representations.
 */
...
public final class HalfFloatArray extends TornadoNativeArray {
  ...
  /**
   * Constructs a new instance of the {@link HalfFloatArray} that will store a user-specified number
   * of elements.
   *
  ...
  /**
   * Constructs a new {@link HalfFloatArray} instance by concatenating the contents of the given
   * array of {@link HalfFloatArray} instances.
   *
   * @param arrays An array of {@link HalfFloatArray} instances to be concatenated into the new
   *     instance.
   */
   ...
   *
   * @param values The on-heap {@link HalfFloat} to create the instance from.
   * @return A new {@link HalfFloatArray} instance, initialized with values of the on-heap {@link
   *     HalfFloat} array.
   */
   ...
   *
   * @param values The on-heap {@link HalfFloat} array to create the instance from.
   * @return A new {@link HalfFloatArray} instance, initialized with values of the on-heap {@link
   *     HalfFloat} array.
   */
  ...
  /**
   * Creates a new instance of the {@link HalfFloatArray} class from a set of {@link HalfFloat}
   * values.
   *
   * @param values The {@link HalfFloat} values to initialize the array with.
   ...
   *
   * @param segment The {@link MemorySegment} containing the off-heap half float data.
  ...
  public static HalfFloatArray fromSegment(MemorySegment segment) {
    ...
    MemorySegment.copy(
        segment,
        0,
        halfFloatArray.segment,
        (long) halfFloatArray.baseIndex * HALF_FLOAT_BYTES,
        byteSize);
    return halfFloatArray;
  }

  /**
   * Converts the {@link HalfFloat} data from off-heap to on-heap, by copying the values of a {@link
   * HalfFloatArray} instance into a new on-heap {@link HalfFloat}.
   *
   * @return A new on-heap {@link HalfFloat} array, initialized with the values stored in the {@link
   *     HalfFloatArray} instance.
   */
  ...
  /**
   * Converts the {@link HalfFloat} data from off-heap to an on-heap short representation, by
   * getting the values of a {@link HalfFloatArray} instance as short and coping them into a new
   * on-heap short array.
   *
   * @return A new on-heap short array, initialized with the values stored in the {@link
   *     HalfFloatArray} instance.
   */
   ...
   *
   * @param index The index at which to set the {@link HalfFloat} value.
   * @param value The {@link HalfFloat} value to store at the specified index.
   */
  ...
  /**
   * Gets the {@link HalfFloat} value stored at the specified index of the {@link HalfFloatArray}
   * instance.
   *
   * @param index The index of which to retrieve the {@link HalfFloat} value.
   * @return
   */
   ...
   *
   * @param value The {@link HalfFloat} value to initialize the {@link HalfFloatArray} instance
   *     with.
   */
  ...
  /**
   * Returns the underlying {@link MemorySegment} of the {@link HalfFloatArray} instance, including
   * the header.
   *
   * @return The {@link MemorySegment} associated with the {@link HalfFloatArray} instance.
   */
  ...
  /**
   * Returns the total number of bytes that the {@link MemorySegment}, associated with the {@link
   * HalfFloatArray} instance, occupies.
   *
  ...
  /**
   * Returns the number of bytes of the {@link MemorySegment} that is associated with the {@link
   * HalfFloatArray} instance, excluding the header bytes.
   *
  ...
  /**
   * Factory method to initialize a {@link HalfFloatArray}. This method can be invoked from a
   * Task-Graph.
   *
   * @param array Input Array.
   * @param value The float value to initialize the {@code HalfFloatArray} instance with.
   */
   ...
   *
   * @param arrays Variable number of {@link HalfFloatArray} objects to be concatenated.
  ...
  /**
   * Extracts a slice of elements from a given {@linkHalfFloatArray}, creating a new
   * {@linkHalfFloatArray} instance.
   *
   ...
   * @return A new {@linkHalfFloatArray} instance representing the specified slice of the original
   *     array.
   * @throws IllegalArgumentException if the specified slice is out of the bounds of the original
   *     array.
   */
