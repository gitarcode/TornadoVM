...
/**
 * This class represents an array of doubles stored in native memory. The double data is stored in a
 * {@link MemorySegment}, which represents a contiguous region of off-heap memory. The class also
 * encapsulates methods for setting and getting double values, for initializing the double array,
 * and for converting the array to and from different representations.
 */
...
public final class DoubleArray extends TornadoNativeArray {
  ...
  /**
   * Constructs a new instance of the {@link DoubleArray} that will store a user-specified number of
   * elements.
   *
  ...
  /**
   * Constructs a new {@link DoubleArray} instance by concatenating the contents of the given array
   * of {@link DoubleArray} instances.
   *
   * @param arrays An array of {@link DoubleArray} instances to be concatenated into the new
   *     instance.
   */
   ...
   * @return A new {@link DoubleArray} instance, initialized with values of the on-heap double
   *     array.
   */
  ...
  public static DoubleArray fromSegment(MemorySegment segment) {
    ...
    MemorySegment.copy(
        segment, 0, doubleArray.segment, doubleArray.baseIndex * DOUBLE_BYTES, byteSize);
    return doubleArray;
  }
   ...
   *
   * @param buffer The {@link DoubleBuffer} containing the double data.
  ...
  /**
   * Converts the double data from off-heap to on-heap, by copying the values of a {@link
   * DoubleArray} instance into a new on-heap array.
   *
   * @return A new on-heap double array, initialized with the values stored in the {@link
   ...
   *
   * @param value The double value to initialize the {@link DoubleArray} instance with.
   */
  ...
  /**
   * Returns the underlying {@link MemorySegment} of the {@link DoubleArray} instance, including the
   * header.
   *
   * @return The {@link MemorySegment} associated with the {@link DoubleArray} instance.
   */
   ...
   * DoubleArray} instance, excluding the header bytes.
   *
  ...
  /**
   * Factory method to initialize a {@link DoubleArray}. This method can be invoked from a
   * Task-Graph.
   *
   * @param array Input Array.
   * @param value The float value to initialize the {@code DoubleArray} instance with.
   */
   ...
   *
   * @param arrays Variable number of {@link DoubleArray} objects to be concatenated.
  ...
  /**
   * Extracts a slice of elements from a given {@link DoubleArray}, creating a new {@link
   * DoubleArray} instance.
   *
   ...
   * @return A new {@link DoubleArray} instance representing the specified slice of the original
   *     array.
