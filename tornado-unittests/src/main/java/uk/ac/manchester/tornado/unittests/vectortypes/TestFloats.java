...
public class TestFloats extends TornadoTestBase {
  ...
  public void privateVectorFloat2() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < size; i++) {
      assertThat(
          (double) tornadoOutput.get(i).getX(), closeTo(sequentialOutput.get(i).getX(), DELTA));
      assertThat(
          (double) tornadoOutput.get(i).getY(), closeTo(sequentialOutput.get(i).getY(), DELTA));
    }
  }
  ...
  public void privateVectorFloat4() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < size; i++) {
      ...
      assertThat(
          (double) tornadoOutput.get(i).getY(), closeTo(sequentialOutput.get(i).getY(), DELTA));
      assertThat(
          (double) tornadoOutput.get(i).getZ(), closeTo(sequentialOutput.get(i).getZ(), DELTA));
      assertThat(
          (double) tornadoOutput.get(i).getW(), closeTo(sequentialOutput.get(i).getW(), DELTA));
    }
  }
  ...
  public void privateVectorFloat8() throws TornadoExecutionPlanException {
    ...
    for (int i = 0; i < size; i++) {
      assertThat(
          (double) tornadoOutput.get(i).getS0(), closeTo(sequentialOutput.get(i).getS0(), DELTA));
      assertThat(
          (double) tornadoOutput.get(i).getS1(), closeTo(sequentialOutput.get(i).getS1(), DELTA));
      assertThat(
          (double) tornadoOutput.get(i).getS2(), closeTo(sequentialOutput.get(i).getS2(), DELTA));
      assertThat(
          (double) tornadoOutput.get(i).getS3(), closeTo(sequentialOutput.get(i).getS3(), DELTA));
      assertThat(
          (double) tornadoOutput.get(i).getS4(), closeTo(sequentialOutput.get(i).getS4(), DELTA));
      assertThat(
          (double) tornadoOutput.get(i).getS5(), closeTo(sequentialOutput.get(i).getS5(), DELTA));
      assertThat(
          (double) tornadoOutput.get(i).getS6(), closeTo(sequentialOutput.get(i).getS6(), DELTA));
      assertThat(
          (double) tornadoOutput.get(i).getS7(), closeTo(sequentialOutput.get(i).getS7(), DELTA));
    }
  }
