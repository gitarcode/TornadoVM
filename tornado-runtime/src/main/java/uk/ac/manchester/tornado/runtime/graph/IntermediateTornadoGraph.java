...
/**
 * It represents an intermediate graph used during the dependency analysis of a {@link
 * TornadoGraph}. This class provides methods to analyze the intermediate graph and retrieve
 * information about the graph's dependencies .
 */
public class IntermediateTornadoGraph {
   ...
   *
   * @param asyncNodes The {@link BitSet} representing the asynchronous nodes in the graph.
   * @param graph The {@link TornadoGraph} to analyze.
   */
