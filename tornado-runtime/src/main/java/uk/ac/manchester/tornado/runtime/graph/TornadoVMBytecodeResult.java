...
/**
 * It represents the result of a {@link
 * uk.ac.manchester.tornado.runtime.graph.TornadoVMBytecodeBuilder}. It contains the bytecode and
 * its size.
 */
/**
 * The TornadoVMBytecodeResult class represents the result of a TornadoVM bytecode compilation. It
 * provides methods to access and manipulate the bytecode.
 */
public class TornadoVMBytecodeResult {
  ...
  /**
   * Constructs a new TornadoVMBytecodeResult object with the given bytecode and size.
   *
   * @param bytecode the bytecode as a byte array
  ...
  /**
   * Sets up the bytecode buffer using the given bytecode array and size. The buffer is set to
   * little-endian byte order and its limit is set to the given size.
   *
   * @param bytecode the bytecode as a byte array
   * @param size the size of the bytecode
  ...
  /**
   * Retrieves the next four bytes from the bytecode buffer and interprets them as an integer value.
   *
  ...
  /**
   * Retrieves the next eight bytes from the bytecode buffer and interprets them as a long value.
   *
