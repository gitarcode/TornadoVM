...
/**
 * The {@link TornadoKernelContextReplacement} phase is performed during {@link
 * uk.ac.manchester.tornado.runtime.graal.compiler.TornadoSketchTier}. The objective is to replace
 * all the FieldNodes of the {@link KernelContext} fields with FixedNodes that can be lowered to
 * TornadoVM nodes for OpenCL, SPIR-V and PTX code emission.
 */
public class TornadoKernelContextReplacement extends BasePhase<TornadoSketchTierContext> {
  ...
  private void replaceKernelContextNode(
      StructuredGraph graph,
      ArrayList<Node> nodesToBeRemoved,
      LoadFieldNode oldNode,
