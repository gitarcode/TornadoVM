...
public class TornadoAddressArithmeticNode extends FloatingNode implements LIRLowerable {
  ...
  public static final NodeClass<TornadoAddressArithmeticNode> TYPE =
      NodeClass.create(TornadoAddressArithmeticNode.class);

  @Node.Input protected ValueNode base;

  @Node.Input protected ValueNode offset;
