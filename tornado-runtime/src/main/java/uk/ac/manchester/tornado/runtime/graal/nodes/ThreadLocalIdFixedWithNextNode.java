...
/**
 * The {@link ThreadLocalIdFixedWithNextNode} is used to replace the FieldNodes that correspond to
 * the {@link KernelContext}. In essence, these fields are: localIdx, localIdy and localIdz.
 *
 ...
 * PTXLoweringProvider, and drives the {@link ThreadLocalIdFixedWithNextNode} to extend
...
public class ThreadLocalIdFixedWithNextNode extends FixedWithNextNode implements Lowerable {
  ...
  public static final NodeClass<ThreadLocalIdFixedWithNextNode> TYPE =
      NodeClass.create(ThreadLocalIdFixedWithNextNode.class);
