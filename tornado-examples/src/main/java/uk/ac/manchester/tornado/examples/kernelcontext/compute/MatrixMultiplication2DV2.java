...
/**
 * Example of Matrix Multiplication for square matrices written in Java. This implementation follows
 * the OpenCL implementation description provided in {@url https://github.com/cnugteren/myGEMM}.
 *
 * <p>In detail, it applies the following optimizations: (i) Thread attributes to utilize two
 * dimensions, and (ii) Local memory & Loop tiling.
 *
 * <p>How to run: <code>
  ...
  public static void main(String[] args) {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                MatrixMultiplication2DV2::matrixMultiplication,
                context,
                matrixA,
                matrixB,
                matrixC,
    ...
    System.out.println(
        "\tSequential Execution: "
            + formatSequentialGFlops
            + " GFlops, Total time = "
            + (endSequential - startSequential)
            + " ms");
    System.out.println(
        "\tTornadoVM Execution with Local Memory and Loop Tiling: "
            + formatTornadoVMGFlops
            + " GFlops, Total Time = "
            + (end - start)
            + " ms");
