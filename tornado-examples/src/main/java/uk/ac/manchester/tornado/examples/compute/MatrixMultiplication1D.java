...
public class MatrixMultiplication1D {
  ...
  private static void matrixMultiplication(
      final FloatArray matrixA, final FloatArray matrixB, final FloatArray result, final int size) {
  ...
  public static void main(String[] args) throws NumberFormatException {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0",
                MatrixMultiplication1D::matrixMultiplication,
                matrixA,
                matrixB,
                matrixC,
                size) //
