...
public class ReductionsLocalMemory {
  ...
  public static void reductionLocal(
      FloatArray a, FloatArray b, int localSize, KernelContext context) {
  ...
  public static void main(String[] args) {
    ...
    TaskGraph taskGraph =
        new TaskGraph("s0") //
            ...
            .task(
                "t0", ReductionsLocalMemory::reductionLocal, input, reduce, localSize, context) //
