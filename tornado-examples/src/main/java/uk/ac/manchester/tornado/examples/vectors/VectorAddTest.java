...
/**
 * Test Using the Profiler and Vector Types in TornadoVM. This test sets the device index to 2. To
 * change the device index.
 *
 * <p>How to run? Select in the first argument the desired vector length: {vector2, vector4,
 * vector8}. Run with the vector types: <code>
 ...
 * </code> Run with no vector types: <code>
 ...
 * </code> Run with Java Streams: <code>
...
public class VectorAddTest {
  ...
  private static void runWithoutVectorTypes(int size, TornadoDevice device) {
    ...
    TaskGraph taskGraphNonVector =
        new TaskGraph("nonVector") //
  ...
  private static void computeWithStreams(
      final int size, FloatArray a, FloatArray b, FloatArray results) {
