...
/**
 * Program taken from the Marawacc parallel programming framework with the permission from the
 * author.
 *
 * <p>It takes an input coloured input image and transforms it into a grey-scale image.
 *
 * <p>How to run? <code>
...
public class BlackAndWhiteTransform {
  ...
  public static class LoadImage extends Component {
    ...
    private static final boolean PARALLEL_COMPUTATION =
        Boolean.parseBoolean(System.getProperty("run::parallel", "False"));
