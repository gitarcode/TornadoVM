...
public class NBodyMT {
  ...
  private static void nBodyThreads(
      int numBodies,
      float[] refPos,
      float[] refVel,
      float delT,
  ...
  private static void nBody(
      int numBodies, float[] refPos, float[] refVel, float delT, float espSqr, int[] inputSize) {
  ...
  public static boolean validate(
      int numBodies,
      float[] positionsResult,
      float[] velocityResult,
      float delT,
      float espSqr,
      int[] inputSize,
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    if (!executionType.equals("multi") && !executionType.equals("sequential")) {
      ...
      graph
          .transferToDevice(DataTransferMode.FIRST_EXECUTION, positions, velocity, inputSize) //
