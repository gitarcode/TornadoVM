...
/**
 * Simple example of how to perform a flat-map with TornadoVM. Since we currently don't support
 * dynamic memory allocation, the space for the output has to be allocated before running the method
