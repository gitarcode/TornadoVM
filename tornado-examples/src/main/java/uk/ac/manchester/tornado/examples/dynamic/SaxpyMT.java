...
public class SaxpyMT {
  ...
  public static void saxpyThreads(
      float alpha, FloatArray x, FloatArray y, FloatArray b, int threads, Thread[] th)
  ...
  public static void main(String[] args) {
    ...
    if (!executionType.equals("multi") && !executionType.equals("sequential")) {
      ...
      graph
          .transferToDevice(DataTransferMode.FIRST_EXECUTION, x, b) //
